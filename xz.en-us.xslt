...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="lang.Comforts"		select="'Comforts'"/>
	...
	<xsl:variable name="lang.Entertainment"	select="'Entertainment'"/>
	...
	<xsl:variable name="lang.Necessities"	select="'Necessities'"/>
	<xsl:variable name="lang.Neighborhood"	select="'Neighborhood'"/>
	...
	<xsl:variable name="lang.Security"		select="'Security'"/>
