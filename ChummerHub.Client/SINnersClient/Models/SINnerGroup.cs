...
namespace SINners.Models
{
    ...
    public partial class SINnerGroup
    {
        ...
        public virtual void Validate()
        {
            ...
            if (MyGroups != null)
            {
                foreach (var element in MyGroups)
                {
                    if (element != null)
                    {
                        element.Validate();
