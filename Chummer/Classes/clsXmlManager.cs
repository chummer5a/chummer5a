    ...
    public static class XmlManager
    {
        ...
        public static XmlDocument Load(string strFileName, string strLanguage = "", bool blnLoadFile = false)
        {
            ...
            if (string.IsNullOrEmpty(strLanguage))
                strLanguage = GlobalOptions.Instance.Language;
        ...
        private static void CheckIdNodes(XmlNode xmlParentNode, string strFileName)
        {
            ...
            if (setDuplicateIDs.Count > 0)
            {
                ...
                MessageBox.Show(string.Format(LanguageManager.GetString("Message_DuplicateGuidWarning", GlobalOptions.Instance.Language)
            ...
            if (lstItemsWithMalformedIDs.Count > 0)
            {
                ...
                MessageBox.Show(string.Format(LanguageManager.GetString("Message_NonGuidIdWarning", GlobalOptions.Instance.Language)
