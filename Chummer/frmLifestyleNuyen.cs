...
namespace Chummer
{
    public partial class frmLifestyleNuyen : Form
    {
        ...
        {
            lblDice.Text = string.Format(LanguageManager.GetString("Label_LifestyleNuyen_ResultOf", GlobalOptions.Language), Dice.ToString(GlobalOptions.Instance.CultureInfo));
