    ...
    public partial class SelectPower : Form
    {
        ...
        private async void lstPowers_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(strSelectedId))
                objXmlPower = _xmlBasePowerDataNode.TryGetNodeByNameOrId("powers/power", strSelectedId.CleanXPath());
        ...
        private async ValueTask AcceptForm(CancellationToken token = default)
        {
            ...
            if (!string.IsNullOrEmpty(strSelectedId))
            {
                ...
                XPathNavigator objXmlPower = _xmlBasePowerDataNode.TryGetNodeByNameOrId("powers/power", strSelectedId.CleanXPath());
