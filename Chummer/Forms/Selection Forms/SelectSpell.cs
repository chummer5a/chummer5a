...
namespace Chummer
{
    public partial class SelectSpell : Form
    {
        ...
        private async ValueTask AcceptForm(CancellationToken token = default)
        {
            ...
            XPathNavigator objXmlSpell = _xmlBaseSpellDataNode.TryGetNodeByNameOrId("spells/spell", strSelectedItem.CleanXPath());
        ...
        private async ValueTask UpdateSpellInfo(CancellationToken token = default)
        {
            ...
            {
                xmlSpell = _xmlBaseSpellDataNode.TryGetNodeByNameOrId("/chummer/spells/spell", strSelectedSpellId.CleanXPath());
            }
            if (xmlSpell == null)
            {
