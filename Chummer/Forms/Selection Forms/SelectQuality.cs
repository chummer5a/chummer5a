    ...
    public partial class SelectQuality : Form
    {
        ...
        private async void lstQualities_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    xmlQuality = _xmlBaseQualityDataNode.TryGetNodeByNameOrId("qualities/quality",strSelectedQuality.CleanXPath());
                }
        ...
        private async ValueTask AcceptForm(CancellationToken token = default)
        {
            ...
            XPathNavigator objNode = _xmlBaseQualityDataNode.TryGetNodeByNameOrId("qualities/quality", strSelectedQuality.CleanXPath());
