...
namespace Chummer
{
    public partial class SelectArt : Form
    {
        ...
        private async void lstArt_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            XPathNavigator objXmlMetamagic = _objXmlDocument.TryGetNodeByNameOrId(_strBaseXPath,strSelected.CleanXPath());
        ...
        private void AcceptForm()
        {
            ...
            if (!string.IsNullOrEmpty(strSelectedItem))
            {
                ...
                XPathNavigator objXmlMetamagic = _objXmlDocument.TryGetNodeByNameOrId(_strBaseXPath, strSelectedItem.CleanXPath());
