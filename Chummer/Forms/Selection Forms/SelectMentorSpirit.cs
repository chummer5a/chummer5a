...
namespace Chummer
{
    public partial class SelectMentorSpirit : Form
    {
        ...
        private async void lstMentor_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (lstMentor.SelectedIndex >= 0)
                {
                    ...
                    {
                        objXmlMentor =
                            _xmlBaseMentorSpiritDataNode.TryGetNodeByNameOrId("mentors/mentor", strSelectedId.CleanXPath());
                    }
                }
        ...
        private void AcceptForm(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(strSelectedId))
            {
                XPathNavigator objXmlMentor = _xmlBaseMentorSpiritDataNode.TryGetNodeByNameOrId("mentors/mentor", strSelectedId.CleanXPath());
                if (objXmlMentor == null)
                    return;
