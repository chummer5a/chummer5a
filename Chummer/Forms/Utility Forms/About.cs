...
namespace Chummer
{
    public partial class About : Form
    {
        ...
        private async void About_Load(object sender, EventArgs e)
        {
            ...
            string strContributors = Utils.DoubleNewLine + StringExtensions.JoinFast(Environment.NewLine, Properties.Contributors.Usernames)
                                                                   + Environment.NewLine + "/u/Iridios";
            await txtContributors.DoThreadSafeAsync(x => x.Text += strContributors).ConfigureAwait(false);
