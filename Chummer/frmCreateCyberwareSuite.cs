...
namespace Chummer
{
    public sealed partial class frmCreateCyberwareSuite : Form
    {
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            ...
            if (XmlManager.Load(_strType + ".xml", _objCharacter.Options.CustomDataDictionary, GlobalOptions.Language).SelectSingleNode("/chummer/suites/suite[name = \"" + strName + "\"]") != null)
            {
