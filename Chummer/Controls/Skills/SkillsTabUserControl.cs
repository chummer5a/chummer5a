...
namespace Chummer.UI.Skills
{
    public partial class SkillsTabUserControl : UserControl, IHasCharacterObject
    {
        ...
        private List<ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>> _lstDropDownActiveSkills;
        private List<ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>> _lstSortSkills;
        private bool _blnActiveSkillSearchMode;
        private bool _blnKnowledgeSkillSearchMode;
        private List<ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>> _lstDropDownKnowledgeSkills;
        private List<ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>> _lstSortKnowledgeSkills;
        ...
        private static async Task<List<ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>>> GenerateSortList(CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            List<ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>> ret = new List<ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>>(9)
            {
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortAlphabetical", token: token).ConfigureAwait(false),
                    new SkillSorter(SkillsSection.CompareSkills), new AsyncSkillSorter(SkillsSection.CompareSkillsAsync)),
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortRating", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
                ...
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortDicepool", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
                ...
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortLowerDicepool", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
                ...
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortAttributeValue", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
                ...
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortAttributeName", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
                ...
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortGroupName", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
                ...
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortGroupRating", token: token).ConfigureAwait(false),
                    new SkillSortBySkillGroup(), new AsyncSkillSortBySkillGroup()),
                new ValueTuple<string, IComparer<Skill>, IAsyncComparer<Skill>>(await LanguageManager.GetStringAsync("Skill_SortCategory", token: token).ConfigureAwait(false),
                    new SkillSorter((x, y) =>
                    {
        ...
        private static async Task<List<ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>>> GenerateDropdownFilter(Character objCharacter, CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            List<ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>> ret = new List<ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>>(7)
            {
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_Search", token: token).ConfigureAwait(false),
                    null, null),
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_SkillFilterAll", token: token).ConfigureAwait(false),
                    x => true, (x, t) => Task.FromResult(true)),
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_SkillFilterRatingAboveZero", token: token).ConfigureAwait(false),
                    skill => skill.Rating > 0,
                    async (skill, t) => await skill.GetRatingAsync(t).ConfigureAwait(false) > 0),
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_SkillFilterTotalRatingAboveZero", token: token).ConfigureAwait(false),
                    skill => skill.Pool > 0,
                    async (skill, t) => await skill.GetPoolAsync(t).ConfigureAwait(false) > 0),
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_SkillFilterRatingZero", token: token).ConfigureAwait(false),
                    skill => skill.Rating == 0,
                    async (skill, t) => await skill.GetRatingAsync(t).ConfigureAwait(false) == 0),
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_SkillFilterNoSkillGroup", token: token).ConfigureAwait(false),
                    skill => skill.SkillGroup.Length == 0,
                    (skill, t) => Task.FromResult(skill.SkillGroup.Length == 0)),
                new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_SkillFilterBrokenSkillGroup", token: token).ConfigureAwait(false),
                ...
                .SelectAndCacheExpression("/chummer/categories/category[@type = \"active\"]", token))
            {
                ...
                if (!string.IsNullOrEmpty(strName))
                    ret.Add(new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(
            ...
            foreach (string strAttribute in AttributeSection.AttributeStrings)
            {
                ...
                if (!string.IsNullOrEmpty(strAttributeShort))
                    ret.Add(new ValueTuple<string, Predicate<Skill>, Func<Skill, CancellationToken, Task<bool>>>(strAttributeLabel + strColon + strSpace + strAttributeShort,
        ...
        private static async Task<List<ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>>> GenerateKnowledgeSortList(CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            List<ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>> ret = new List<ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>>(7)
            {
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortAlphabetical", token: token).ConfigureAwait(false),
                    new KnowledgeSkillSorter(SkillsSection.CompareSkills), new AsyncKnowledgeSkillSorter(SkillsSection.CompareSkillsAsync)),
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortRating", token: token).ConfigureAwait(false),
                ...
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortDicepool", token: token).ConfigureAwait(false),
                    new KnowledgeSkillSorter((x, y) =>
                    {
                        int intReturn = y.Pool.CompareTo(x.Pool);
                        if (intReturn == 0)
                ...
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortLowerDicepool", token: token).ConfigureAwait(false),
                    new KnowledgeSkillSorter((x, y) =>
                    {
                        int intReturn = x.Pool.CompareTo(y.Pool);
                        if (intReturn == 0)
                ...
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortAttributeValue", token: token).ConfigureAwait(false),
                    new KnowledgeSkillSorter((x, y) =>
                    {
                        int intReturn = y.AttributeModifiers.CompareTo(x.AttributeModifiers);
                        if (intReturn == 0)
                ...
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortAttributeName", token: token).ConfigureAwait(false),
                    new KnowledgeSkillSorter((x, y) =>
                    {
                        int intReturn = string.Compare(x.DisplayAttribute, y.DisplayAttribute, false, GlobalSettings.CultureInfo);
                        if (intReturn == 0)
                ...
                new ValueTuple<string, IComparer<KnowledgeSkill>, IAsyncComparer<KnowledgeSkill>>(await LanguageManager.GetStringAsync("Skill_SortCategory", token: token).ConfigureAwait(false),
                    new KnowledgeSkillSorter((x, y) =>
                    {
                        int intReturn = string.Compare(x.CurrentDisplayCategory, y.CurrentDisplayCategory, false, GlobalSettings.CultureInfo);
                        if (intReturn == 0)
        ...
        private static async Task<List<ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>>> GenerateKnowledgeDropdownFilter(Character objCharacter, CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            List<ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>> ret = new List<ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>>(5)
            {
                //TODO: Search doesn't play nice with writable name
                new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_Search", token: token).ConfigureAwait(false),
                    null, null),
                new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_KnowledgeSkillFilterAll", token: token).ConfigureAwait(false),
                    x => true, (x, t) => Task.FromResult(true)),
                new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_KnowledgeSkillFilterRatingAboveZero", token: token).ConfigureAwait(false),
                    skill => skill.Rating > 0,
                    async (skill, t) => await skill.GetRatingAsync(t).ConfigureAwait(false) > 0),
                new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_KnowledgeSkillFilterTotalRatingAboveZero", token: token).ConfigureAwait(false),
                    skill => skill.Pool > 0,
                    async (skill, t) => await skill.GetPoolAsync(t).ConfigureAwait(false) > 0),
                new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(await LanguageManager.GetStringAsync("String_KnowledgeSkillFilterRatingZero", token: token).ConfigureAwait(false),
                    skill => skill.Rating == 0,
                    async (skill, t) => await skill.GetRatingAsync(t).ConfigureAwait(false) == 0)
            };
            //TODO: TRANSLATIONS
                ...
                .SelectAndCacheExpression("/chummer/categories/category[@type = \"knowledge\"]", token))
            {
                string strName = xmlCategoryNode.Value;
                if (!string.IsNullOrEmpty(strName))
                    ret.Add(new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(
                        strCategory + strSpace + (xmlCategoryNode.SelectSingleNodeAndCacheExpression("@translate", token)?.Value ?? strName),
                        skill => skill.SkillCategory == strName,
                        (skill, t) => Task.FromResult(skill.SkillCategory == strName)));
            }
            ...
            foreach (string strAttribute in AttributeSection.AttributeStrings)
            {
                string strAttributeShort = await LanguageManager.GetStringAsync("String_Attribute" + strAttribute + "Short", GlobalSettings.Language, false, token).ConfigureAwait(false);
                if (!string.IsNullOrEmpty(strAttributeShort))
                    ret.Add(new ValueTuple<string, Predicate<KnowledgeSkill>, Func<KnowledgeSkill, CancellationToken, Task<bool>>>(strAttributeLabel + strColon + strSpace + strAttributeShort,
                        skill => skill.Attribute == strAttribute,
                        async (skill, t) => await skill.GetAttributeAsync(t).ConfigureAwait(false) == strAttribute));
            }
