...
namespace Chummer.UI.Skills
{
    public sealed partial class KnowledgeSkillControl : UserControl
    {
        ...
        public KnowledgeSkillControl(KnowledgeSkill objSkill, CancellationToken objMyToken = default)
        {
            ...
            objSkill.PropertyChangedAsync += Skill_PropertyChanged;
        ...
        private async Task Skill_PropertyChanged(object sender, PropertyChangedEventArgs e, CancellationToken token = default)
        {
            bool blnAll = false;
            try
            {
