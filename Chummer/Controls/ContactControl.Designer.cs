namespace Chummer
{
    partial class ContactControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cboContactRole = new ElasticComboBox();
            ...
            this.cboSex = new ElasticComboBox();
            this.cboType = new ElasticComboBox();
            this.cboPreferredPayment = new ElasticComboBox();
            this.cboAge = new ElasticComboBox();
            this.cboHobbiesVice = new ElasticComboBox();
            this.cboPersonalLife = new ElasticComboBox();
