    ...
    public partial class frmSelectSpell : Form
    {
        ...
        private void UpdateSpellInfo()
        {
            ...
            foreach (string strDescriptor in strDescriptorsIn)
            {
                ...
                {
                    case "Adept":
                        objDescriptors.Append(LanguageManager.GetString("String_DescAdept"));
                        objDescriptors.Append(", ");
                        break;
                    case "Anchored":
                        objDescriptors.Append(LanguageManager.GetString("String_DescAnchored"));
                        objDescriptors.Append(", ");
                        break;
                    case "Blood":
                        objDescriptors.Append(LanguageManager.GetString("String_DescBlood"));
                        objDescriptors.Append(", ");
                        break;
                    case "Contractual":
                        objDescriptors.Append(LanguageManager.GetString("String_DescContractual"));
                        objDescriptors.Append(", ");
                        break;
                    case "Geomancy":
                        objDescriptors.Append(LanguageManager.GetString("String_DescGeomancy"));
                        objDescriptors.Append(", ");
                        break;
                    case "Mana":
                        objDescriptors.Append(LanguageManager.GetString("String_DescMana"));
                        objDescriptors.Append(", ");
                        break;
                    case "Material Link":
                        ...
                        break;
                    case "Minion":
                        objDescriptors.Append(LanguageManager.GetString("String_DescMinion"));
                        objDescriptors.Append(", ");
                        break;
                    case "Organic Link":
                        ...
                        break;
                    case "Spell":
                        objDescriptors.Append(LanguageManager.GetString("String_DescSpell"));
                        objDescriptors.Append(", ");
                        break;
                    case "Spotter":
                        objDescriptors.Append(LanguageManager.GetString("String_DescSpotter"));
                        objDescriptors.Append(", ");
                        break;
                }
            }
            ...
            string strDV = objXmlSpell["dv"].InnerText.Replace('/', '÷').CheapReplace("F", () => LanguageManager.GetString("String_SpellForce"));
            strDV = strDV.CheapReplace("Overflow damage", () => LanguageManager.GetString("String_SpellOverflowDamage"));
            strDV = strDV.CheapReplace("Damage Value", () => LanguageManager.GetString("String_SpellDamageValue"));
            strDV = strDV.CheapReplace("Toxin DV", () => LanguageManager.GetString("String_SpellToxinDV"));
            strDV = strDV.CheapReplace("Disease DV", () => LanguageManager.GetString("String_SpellDiseaseDV"));
            strDV = strDV.CheapReplace("Radiation Power", () => LanguageManager.GetString("String_SpellRadiationPower"));
