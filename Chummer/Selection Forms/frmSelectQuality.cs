...
namespace Chummer
{
    public partial class frmSelectQuality : Form
    {
            ...
            if (xmlQuality != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (_objCharacter.Created && _objCharacter.Options.DoubleQualityPurchases)
                        {
        ...
        private void AcceptForm()
        {
            ...
            s_StrSelectCategory = (GlobalOptions.Instance.SearchInCategoryOnly || txtSearch.TextLength == 0) ? cboCategory.SelectedValue?.ToString() : objNode.SelectSingleNode("category")?.Value;
