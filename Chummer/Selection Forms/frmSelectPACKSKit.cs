    ...
    public partial class frmSelectPACKSKit : Form
    {
        ...
        private void lstKits_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (XPathNavigator objXmlItem in objXmlPack.SelectChildren(XPathNodeType.Element))
            {
                ...
                {
                    case "attributes":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Attributes", GlobalOptions.Instance.Language);
                        ...
                        foreach (XPathNavigator objXmlAttribute in objXmlItem.SelectChildren(XPathNodeType.Element))
                        {
                            ...
                            {
                                Text = LanguageManager.GetString("String_Attribute" + strNameUpper + "Short", GlobalOptions.Instance.Language) + strSpaceCharacter + (Convert.ToInt32(objXmlAttribute.Value) - (6 - _objCharacter.GetAttribute(strNameUpper).MetatypeMaximum)).ToString(GlobalOptions.Instance.CultureInfo)
                            };
                        ...
                        break;
                    case "qualities":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Qualities", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        // Positive Qualities.
                        foreach (XPathNavigator objXmlQuality in objXmlItem.Select("positive/quality"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(strSelect))
                                objChild.Text += $" ({LanguageManager.TranslateExtra(strSelect, GlobalOptions.Instance.Language)})";
                            objParent.Nodes.Add(objChild);
                            objParent.Expand();
                        }
                        ...
                        break;
                    case "nuyenbp":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Nuyen", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        TreeNode objNuyenChild = new TreeNode
                        {
                            Text = LanguageManager.GetString("String_SelectPACKSKit_StartingNuyenBP", GlobalOptions.Instance.Language) + strSpaceCharacter + objXmlItem.Value
                        };
                        objParent.Nodes.Add(objNuyenChild);
                        objParent.Expand();
                        break;
                    case "skills":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Skills", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        ...
                        foreach (XPathNavigator objXmlSkill in objXmlItem.Select("skillgroup"))
                        {
                            ...
                            objChild.Text += $"{strSpaceCharacter}{LanguageManager.GetString("String_SelectPACKSKit_Group", GlobalOptions.Instance.Language)}{strSpaceCharacter}{objXmlSkill.SelectSingleNode("rating")?.Value}";
                    ...
                    case "knowledgeskills":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_KnowledgeSkills", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        foreach (XPathNavigator objXmlSkill in objXmlItem.Select("skill"))
                        {
                            if (objXmlSkill.SelectSingleNode("hide") != null)
                    ...
                    case "selectmartialart":
                        {
                            objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_SelectMartialArt", GlobalOptions.Instance.Language);
                            treContents.Nodes.Add(objParent);

                            int intRating = Convert.ToInt32(objXmlItem.SelectSingleNode("@rating")?.Value ?? "1");
                            string strSelect = objXmlItem.SelectSingleNode("@select")?.Value ?? LanguageManager.GetString("String_SelectPACKSKit_SelectMartialArt", GlobalOptions.Instance.Language);

                            TreeNode objMartialArt = new TreeNode
                            {
                                Text = strSelect + strSpaceCharacter + LanguageManager.GetString("String_Rating", GlobalOptions.Instance.Language) + strSpaceCharacter + intRating.ToString(GlobalOptions.Instance.CultureInfo)
                            };
                    ...
                    case "martialarts":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_MartialArts", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                    ...
                    case "powers":
                        {
                            objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Powers", GlobalOptions.Instance.Language);
                            treContents.Nodes.Add(objParent);
                    ...
                    case "programs":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Programs", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        ...
                        break;
                    case "spells":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Spells", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                    ...
                    case "spirits":
                        ...
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Spirits", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        foreach (XPathNavigator objXmlSpirit in objXmlItem.Select("spirit"))
                        {
                            ...
                            TreeNode objChild = new TreeNode
                            {
                                Text = objXmlSpirit.SelectSingleNode("name").Value + strSpaceCharacter + '(' +
                                       LanguageManager.GetString("Label_Spirit_Force", GlobalOptions.Instance.Language) + strSpaceCharacter + objXmlSpirit.SelectSingleNode("force").Value + ',' + strSpaceCharacter +
                                       LanguageManager.GetString("Label_Spirit_ServicesOwed", GlobalOptions.Instance.Language) + strSpaceCharacter + objXmlSpirit.SelectSingleNode("services").Value + ')'
                            };
                            objParent.Nodes.Add(objChild);
                            objParent.Expand();
                        }
                    ...
                    case "lifestyles":
                        ...
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Lifestyles", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        foreach (XPathNavigator objXmlLifestyle in objXmlItem.Select("lifestyle"))
                        {
                            ...
                            TreeNode objChild = new TreeNode
                            {
                                Text = (objXmlLifestyle.SelectSingleNode("translate") ?? objXmlLifestyle.SelectSingleNode("baselifestyle")).Value
                                       ...
                                       + strSpaceCharacter + strIncrementString + string.Format(LanguageManager.GetString("Label_LifestylePermanent", GlobalOptions.Instance.Language), intPermanentAmount.ToString(GlobalOptions.Instance.CultureInfo))
                            };
                        ...
                        break;
                    case "cyberwares":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Cyberware", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        foreach (XPathNavigator objXmlCyberware in objXmlItem.Select("cyberware"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(strRating))
                                objChild.Text += strSpaceCharacter + LanguageManager.GetString("String_Rating", GlobalOptions.Instance.Language) + strSpaceCharacter + strRating;
                            ...
                            foreach (XPathNavigator objXmlChild in objXmlCyberware.Select("cyberwares/cyberware"))
                            {
                                ...
                                if (!string.IsNullOrEmpty(strRating))
                                    objChildChild.Text += strSpaceCharacter + LanguageManager.GetString("String_Rating", GlobalOptions.Instance.Language) + strSpaceCharacter + strRating;
                        ...
                        break;
                    case "biowares":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Bioware", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        ...
                        break;
                    case "armors":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Armor", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        ...
                        break;
                    case "weapons":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Weapons", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        ...
                        break;
                    case "gears":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Gear", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
                        ...
                        break;
                    case "vehicles":
                        objParent.Text = LanguageManager.GetString("String_SelectPACKSKit_Vehicles", GlobalOptions.Instance.Language);
                        treContents.Nodes.Add(objParent);
        ...
        private void cmdDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format(LanguageManager.GetString("Message_DeletePACKSKit", GlobalOptions.Instance.Language), strSelectedKit),
                    LanguageManager.GetString("MessageTitle_Delete", GlobalOptions.Instance.Language), MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.No)
                return;
        ...
        private void WriteGear(XPathNavigator objXmlGear, TreeNode objParent)
        {
            ...
            if (objNode != null)
            {
                ...
                if (!string.IsNullOrEmpty(strExtra))
                    objChild.Text += strSpaceCharacter + LanguageManager.GetString("String_Rating", GlobalOptions.Instance.Language) + strSpaceCharacter + strExtra;
