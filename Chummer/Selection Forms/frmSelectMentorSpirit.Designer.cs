namespace Chummer
{
    partial class frmSelectMentorSpirit
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tableLayoutPanel1.Controls.Add(this.lblDisadvantage, 2, 3);
			this.tableLayoutPanel1.Controls.Add(this.lblDisadvantageLabel, 1, 3);
			this.tableLayoutPanel1.Controls.Add(this.lblAdvantageLabel, 1, 2);
			this.tableLayoutPanel1.Controls.Add(this.lblAdvantage, 2, 2);
