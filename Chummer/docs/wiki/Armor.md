armor.xml (and custom_armor.xml, see [Custom Data Files](https://github.com/chummer5a/chummer5a/wiki/Custom-Data-Files)) contains all of the information for Armor and Armor Modifications.
`
## Structure
    <chummer>
      <categories>
