...
namespace Chummer
{
    public partial class frmCreateSpell : Form
    {
        ...
        private void frmCreateSpell_Load(object sender, EventArgs e)
        {
            ...
            {
                new ListItem("P", LanguageManager.GetString("String_DescPhysical", GlobalOptions.Instance.Language)),
                new ListItem("M", LanguageManager.GetString("String_DescMana", GlobalOptions.Instance.Language))
            };
            ...
            {
                new ListItem("T", LanguageManager.GetString("String_SpellRangeTouchLong", GlobalOptions.Instance.Language)),
                new ListItem("LOS", LanguageManager.GetString("String_SpellRangeLineOfSight", GlobalOptions.Instance.Language))
            };
            ...
            {
                new ListItem("I", LanguageManager.GetString("String_SpellDurationInstantLong", GlobalOptions.Instance.Language)),
                new ListItem("P", LanguageManager.GetString("String_SpellDurationPermanentLong", GlobalOptions.Instance.Language)),
                new ListItem("S", LanguageManager.GetString("String_SpellDurationSustainedLong", GlobalOptions.Instance.Language))
            };
        ...
        private void ChangeModifiers()
        {
            ...
            switch (cboCategory.SelectedValue.ToString())
            {
                case "Detection":
                    chkModifier1.Tag = "+0";
                    chkModifier1.Text = LanguageManager.GetString("Checkbox_DetectionSpell1", GlobalOptions.Instance.Language);
                    chkModifier2.Tag = "+0";
                    chkModifier2.Text = LanguageManager.GetString("Checkbox_DetectionSpell2", GlobalOptions.Instance.Language);
                    chkModifier3.Tag = "+0";
                    chkModifier3.Text = LanguageManager.GetString("Checkbox_DetectionSpell3", GlobalOptions.Instance.Language);
                    chkModifier4.Tag = "+0";
                    chkModifier4.Text = LanguageManager.GetString("Checkbox_DetectionSpell4", GlobalOptions.Instance.Language);
                    chkModifier5.Tag = "+0";
                    chkModifier5.Text = LanguageManager.GetString("Checkbox_DetectionSpell5", GlobalOptions.Instance.Language);
                    chkModifier6.Tag = "+0";
                    chkModifier6.Text = LanguageManager.GetString("Checkbox_DetectionSpell6", GlobalOptions.Instance.Language);
                    chkModifier7.Tag = "+1";
                    chkModifier7.Text = LanguageManager.GetString("Checkbox_DetectionSpell7", GlobalOptions.Instance.Language);
                    chkModifier8.Tag = "+1";
                    chkModifier8.Text = LanguageManager.GetString("Checkbox_DetectionSpell8", GlobalOptions.Instance.Language);
                    chkModifier9.Tag = "+2";
                    chkModifier9.Text = LanguageManager.GetString("Checkbox_DetectionSpell9", GlobalOptions.Instance.Language);
                    chkModifier10.Tag = "+4";
                    chkModifier10.Text = LanguageManager.GetString("Checkbox_DetectionSpell10", GlobalOptions.Instance.Language);
                    chkModifier11.Tag = "+1";
                    chkModifier11.Text = LanguageManager.GetString("Checkbox_DetectionSpell11", GlobalOptions.Instance.Language);
                    chkModifier12.Tag = "+2";
                    chkModifier12.Text = LanguageManager.GetString("Checkbox_DetectionSpell12", GlobalOptions.Instance.Language);
                    chkModifier13.Tag = "+4";
                    chkModifier13.Text = LanguageManager.GetString("Checkbox_DetectionSpell13", GlobalOptions.Instance.Language);
                    chkModifier14.Tag = "+2";
                    chkModifier14.Text = LanguageManager.GetString("Checkbox_DetectionSpell14", GlobalOptions.Instance.Language);
                    break;
                case "Health":
                    chkModifier1.Tag = "+0";
                    chkModifier1.Text = LanguageManager.GetString("Checkbox_HealthSpell1", GlobalOptions.Instance.Language);
                    chkModifier2.Tag = "+4";
                    chkModifier2.Text = LanguageManager.GetString("Checkbox_HealthSpell2", GlobalOptions.Instance.Language);
                    chkModifier3.Tag = "-2";
                    chkModifier3.Text = LanguageManager.GetString("Checkbox_HealthSpell3", GlobalOptions.Instance.Language);
                    chkModifier4.Tag = "+2";
                    chkModifier4.Text = LanguageManager.GetString("Checkbox_HealthSpell4", GlobalOptions.Instance.Language);
                    chkModifier5.Tag = "-2";
                    chkModifier5.Text = LanguageManager.GetString("Checkbox_HealthSpell5", GlobalOptions.Instance.Language);
                    break;
                case "Illusion":
                    chkModifier1.Tag = "-1";
                    chkModifier1.Text = LanguageManager.GetString("Checkbox_IllusionSpell1", GlobalOptions.Instance.Language);
                    chkModifier2.Tag = "+0";
                    chkModifier2.Text = LanguageManager.GetString("Checkbox_IllusionSpell2", GlobalOptions.Instance.Language);
                    chkModifier3.Tag = "-2";
                    chkModifier3.Text = LanguageManager.GetString("Checkbox_IllusionSpell3", GlobalOptions.Instance.Language);
                    chkModifier4.Tag = "+0";
                    chkModifier4.Text = LanguageManager.GetString("Checkbox_IllusionSpell4", GlobalOptions.Instance.Language);
                    chkModifier5.Tag = "+2";
                    chkModifier5.Text = LanguageManager.GetString("Checkbox_IllusionSpell5", GlobalOptions.Instance.Language);
                    break;
                case "Manipulation":
                    chkModifier1.Tag = "-2";
                    chkModifier1.Text = LanguageManager.GetString("Checkbox_ManipulationSpell1", GlobalOptions.Instance.Language);
                    chkModifier2.Tag = "+0";
                    chkModifier2.Text = LanguageManager.GetString("Checkbox_ManipulationSpell2", GlobalOptions.Instance.Language);
                    chkModifier3.Tag = "+0";
                    chkModifier3.Text = LanguageManager.GetString("Checkbox_ManipulationSpell3", GlobalOptions.Instance.Language);
                    chkModifier4.Tag = "+0";
                    chkModifier4.Text = LanguageManager.GetString("Checkbox_ManipulationSpell4", GlobalOptions.Instance.Language);
                    chkModifier5.Tag = "+2";
                    chkModifier5.Text = LanguageManager.GetString("Checkbox_ManipulationSpell5", GlobalOptions.Instance.Language);
                    chkModifier6.Tag = "+2";
                    chkModifier6.Text = LanguageManager.GetString("Checkbox_ManipulationSpell6", GlobalOptions.Instance.Language);
                ...
                default:
                    // Combat.
                    chkModifier1.Tag = "+0";
                    chkModifier1.Text = LanguageManager.GetString("Checkbox_CombatSpell1", GlobalOptions.Instance.Language);
                    chkModifier2.Tag = "+0";
                    chkModifier2.Text = LanguageManager.GetString("Checkbox_CombatSpell2", GlobalOptions.Instance.Language);
                    chkModifier3.Tag = "+2";
                    chkModifier3.Text = LanguageManager.GetString("Checkbox_CombatSpell3", GlobalOptions.Instance.Language);
                    nudNumberOfEffects.Visible = true;
                    nudNumberOfEffects.Top = chkModifier3.Top - 1;
                    chkModifier4.Tag = "+0";
                    chkModifier4.Text = LanguageManager.GetString("Checkbox_CombatSpell4", GlobalOptions.Instance.Language);
                    chkModifier5.Tag = "-1";
                    chkModifier5.Text = LanguageManager.GetString("Checkbox_CombatSpell5", GlobalOptions.Instance.Language);
                    break;
            }
            ...
            foreach (CheckBox chkCheckbox in flpModifiers.Controls.OfType<CheckBox>())
            {
                if (!string.IsNullOrEmpty(chkCheckbox.Text))
                {
                    ...
                    chkCheckbox.Text += LanguageManager.GetString("String_Space", GlobalOptions.Instance.Language) + '(' + chkCheckbox.Tag + ')';
                }
            }
            foreach (Panel panChild in flpModifiers.Controls.OfType<Panel>())
            {
        ...
        private string CalculateDrain()
        {
            ...
            if (cboCategory.SelectedValue.ToString() == "Health" && chkModifier1.Checked)
            {
                ...
                strBase = '(' + LanguageManager.GetString("String_SpellDamageValue", GlobalOptions.Instance.Language) + ')';
            }
            else
            {
            ...
            lblDV.Text = (strBase + strDV).Replace('/', '÷')
                .CheapReplace("F", () => LanguageManager.GetString("String_SpellForce", GlobalOptions.Instance.Language))
        ...
        private void AcceptForm()
        {
            ...
            if (string.IsNullOrWhiteSpace(txtName.Text))
            {
                ...
                strMessage += LanguageManager.GetString("Message_SpellName", GlobalOptions.Instance.Language);
            }
            ...
            if (txtRestriction.Enabled && string.IsNullOrWhiteSpace(txtRestriction.Text))
            {
                if (!string.IsNullOrEmpty(strMessage))
                    strMessage += Environment.NewLine;
                strMessage += LanguageManager.GetString("Message_SpellRestricted", GlobalOptions.Instance.Language);
            }
            ...
            if (cboCategory.SelectedValue.ToString() == "Combat")
            {
                ...
                if (!chkModifier1.Checked && !chkModifier2.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_CombatSpellRequirement1", GlobalOptions.Instance.Language);
                }
                ...
                if (!chkModifier4.Checked && !chkModifier5.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_CombatSpellRequirement2", GlobalOptions.Instance.Language);
                }
            }
            else if (cboCategory.SelectedValue.ToString() == "Detection")
            {
                ...
                if (!chkModifier1.Checked && !chkModifier2.Checked && !chkModifier3.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_DetectionSpellRequirement1", GlobalOptions.Instance.Language);
                }
                ...
                if (!chkModifier4.Checked && !chkModifier5.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_DetectionSpellRequirement2", GlobalOptions.Instance.Language);
                }
            }
            else if (cboCategory.SelectedValue.ToString() == "Health")
            {
            ...
            else if (cboCategory.SelectedValue.ToString() == "Illusion")
            {
                ...
                if (!chkModifier1.Checked && !chkModifier2.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_IllusionSpellRequirement1", GlobalOptions.Instance.Language);
                }
                ...
                if (!chkModifier3.Checked && !chkModifier4.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_IllusionSpellRequirement2", GlobalOptions.Instance.Language);
                }
            }
            else if (cboCategory.SelectedValue.ToString() == "Manipulation")
            {
                ...
                if (!chkModifier1.Checked && !chkModifier2.Checked && !chkModifier3.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_ManipulationSpellRequirement1", GlobalOptions.Instance.Language);
                }
                ...
                if (!chkModifier4.Checked && !chkModifier5.Checked)
                {
                    if (!string.IsNullOrEmpty(strMessage))
                        strMessage += Environment.NewLine;
                    strMessage += LanguageManager.GetString("Message_ManipulationSpellRequirement2", GlobalOptions.Instance.Language);
                }
            }
            ...
            if (!string.IsNullOrEmpty(strMessage))
            {
                MessageBox.Show(strMessage, LanguageManager.GetString("Title_CreateSpell", GlobalOptions.Instance.Language), MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
