...
namespace Chummer
{
    ...
    public partial class frmOmae : Form
    {
        ...
        private void objRecord_OmaeDownloadClicked(Object sender)
        {
            ...
            if (_objMode == OmaeMode.Character)
            {
                if (objRecord.CharacterType != 4)
                {
                    ...
                    {
                        if (MessageBox.Show(string.Format(LanguageManager.GetString("Message_Omae_FileExists"), strFileName),
                                LanguageManager.GetString("MessageTitle_Omae_FileExists"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                            return;
                    }
                    ...
                    try
                    {
                        ...
                        if (bytFile.Length == 0)
                        {
                            Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_CannotFindCharacter"), LanguageManager.GetString("MessageTitle_Omae_CannotFindCharacter"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                            objService.Close();
                            return;
                        }
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_NPCPackDownloaded"), LanguageManager.GetString("MessageTitle_Omae_CharacterDownloaded"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (EndpointNotFoundException)
                    {
                        Program.MainForm.ShowMessageBox(NO_CONNECTION_MESSAGE, NO_CONNECTION_TITLE, MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            else if (_objMode == OmaeMode.Data)
            {
                try
                {
                    ...
                    if (bytFile.Length == 0)
                    {
                        Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_CannotFindData"), LanguageManager.GetString("MessageTitle_Omae_CannotFindData"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                        objService.Close();
                        return;
                    }
                    ...
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_DataDownloaded"), LanguageManager.GetString("MessageTitle_Omae_DataDownloaded"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (EndpointNotFoundException)
                {
                    Program.MainForm.ShowMessageBox(NO_CONNECTION_MESSAGE, NO_CONNECTION_TITLE, MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            else if (_objMode == OmaeMode.Sheets)
            {
                ...
                try
                {
                    ...
                    if (bytFile.Length == 0)
                    {
                        Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_CannotFindSheet"), LanguageManager.GetString("MessageTitle_Omae_CannotFindSheet"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                        objService.Close();
                        return;
                    }
                    ...
                    // Show a message saying everything is done.
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_SheetDownloaded"), LanguageManager.GetString("MessageTitle_Omae_SheetDownloaded"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (EndpointNotFoundException)
                {
                    Program.MainForm.ShowMessageBox(NO_CONNECTION_MESSAGE, NO_CONNECTION_TITLE, MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void objRecord_OmaeDeleteClicked(Object sender)
        {
            if (_objMode == OmaeMode.Character)
            {
                ...
                if (objService.DeleteCharacter(objRecord.CharacterID))
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_CharacterDeleted"), LanguageManager.GetString("MessageTitle_Omae_DeleteCharacter"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                else
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_CharacterDeleteError"), LanguageManager.GetString("MessageTitle_Omae_DeleteCharacter"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (_objMode == OmaeMode.Data)
            {
                ...
                if (objService.DeleteDataFile(objRecord.CharacterID))
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_DataDeleted"), LanguageManager.GetString("MessageTitle_Omae_DeleteData"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                else
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_DataDeleteError"), LanguageManager.GetString("MessageTitle_Omae_DeleteData"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (_objMode == OmaeMode.Sheets)
            {
                ...
                if (objService.DeleteSheet(objRecord.CharacterID))
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_SheetDeleted"), LanguageManager.GetString("MessageTitle_Omae_DeleteData"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                else
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_SheetDeleteError"), LanguageManager.GetString("MessageTitle_Omae_DeleteData"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        #endregion
        ...
        private void cmdRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_ChooseUsername"), LanguageManager.GetString("MessageTitle_Omae_ChooseUsername"), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            if (string.IsNullOrWhiteSpace(txtPassword.Text))
            {
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_ChoosePassword"), LanguageManager.GetString("MessageTitle_Omae_ChoosePassword"), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            try
            {
                ...
                if (intResult == 0)
                {
                    ...
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_AccountCreated"), LanguageManager.GetString("MessageTitle_Omae_Registration"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                else if (intResult == -1)
                {
                    // Username already exists.
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_AccountExists"), LanguageManager.GetString("MessageTitle_Omae_Registration"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
            }
            catch (EndpointNotFoundException)
        ...
        private void cmdLogin_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtUserName.Text))
            {
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_EnterUsername"), LanguageManager.GetString("MessageTitle_Omae_ChooseUsername"), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            if (string.IsNullOrWhiteSpace(txtPassword.Text))
            {
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_EnterPassword"), LanguageManager.GetString("MessageTitle_Omae_ChoosePassword"), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            try
            {
                ...
                if (blnResult)
                {
                    ...
                    _blnLoggedIn = true;
                    lblLoggedIn.Text = string.Format(LanguageManager.GetString("Label_Omae_LoggedInAs"), txtUserName.Text);
                    ...
                    Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_CannotLogin"), LanguageManager.GetString("MessageTitle_Omae_OmaeLogin"), MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (EndpointNotFoundException)
            {
                Program.MainForm.ShowMessageBox(NO_CONNECTION_MESSAGE, NO_CONNECTION_TITLE, MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void cmdUpload_Click(object sender, EventArgs e)
        {
            if (!_blnLoggedIn)
            {
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_MustLogin"), LanguageManager.GetString("MessageTitle_Omae_OmaeLogin"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void cmdPasswordReset_Click(object sender, EventArgs e)
        {
            ...
            if (!objService.ResetPassword(txtUserName.Text))
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_PasswordNoEmail"), LanguageManager.GetString("MessageTitle_Omae_PasswordReset"), MessageBoxButtons.OK, MessageBoxIcon.Error);
            else
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_PasswordReset"), LanguageManager.GetString("MessageTitle_Omae_PasswordReset"), MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void cmdMyAccount_Click(object sender, EventArgs e)
        {
            if (!_blnLoggedIn)
            {
                Program.MainForm.ShowMessageBox(LanguageManager.GetString("Message_Omae_InfoRequiresLogin"), LanguageManager.GetString("MessageTitle_Omae_OmaeLogin"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
