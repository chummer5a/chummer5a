...
namespace Chummer.Backend.Equipment
{
    public class Drug : IHasName, IHasXmlNode, ICanSort, IHasStolenProperty, ICanRemove
    {
        ...
        public string CurrentDisplayName => DisplayName(GlobalOptions.Instance.CultureInfo, GlobalOptions.Language);
            ...
            if (intLevel != -1)
			{
				...
				if (Category == "Custom Drug" || Speed != 0)
				{
				    ...
				    if (Speed <= 0)
				        ...
				        strbldDescription.AppendLine((Speed / 3).ToString(GlobalOptions.Instance.CultureInfo) + strSpaceString + LanguageManager.GetString("String_CombatTurns"));
				    else
				        strbldDescription.AppendLine((Speed).ToString(GlobalOptions.Instance.CultureInfo) + LanguageManager.GetString("String_Seconds"));
                }
            ...
            if (intLevel != -1)
			{
                ...
                if (Category == "Custom Drug" || objDrugEffect.Speed != 0)
				{
				    ...
				    if (objDrugEffect.Speed <= 0)
				        ...
				        strbldDescription.AppendLine((objDrugEffect.Speed / 3).ToString(GlobalOptions.Instance.CultureInfo) + strSpaceString + LanguageManager.GetString("String_CombatTurns"));
                    else
				        strbldDescription.AppendLine((objDrugEffect.Speed).ToString(GlobalOptions.Instance.CultureInfo) + LanguageManager.GetString("String_Seconds"));
                }
			    ...
			    strbldDescription.Append(LanguageManager.GetString("Label_Avail")).Append(strSpaceString).AppendLine(TotalAvail(GlobalOptions.Instance.CultureInfo, GlobalOptions.Language));
			}
			else
            {
