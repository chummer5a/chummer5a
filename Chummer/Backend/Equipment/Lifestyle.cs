...
namespace Chummer.Backend.Equipment
{
    ...
    public class Lifestyle : IHasInternalId, IHasXmlNode, IHasNotes, ICanRemove, IHasCustomName, IHasSource, ICanSort, INotifyPropertyChanged
    {
        ...
        public void Save(XmlTextWriter objWriter)
        {
            ...
            objWriter.WriteElementString("lp", _intLP.ToString(GlobalOptions.Instance.InvariantCultureInfo));
            ...
            objWriter.WriteElementString("maxarea", _intAreaMaximum.ToString(GlobalOptions.Instance.InvariantCultureInfo));
            objWriter.WriteElementString("maxcomforts", _intComfortsMaximum.ToString(GlobalOptions.Instance.InvariantCultureInfo));
            objWriter.WriteElementString("maxsecurity", _intSecurityMaximum.ToString(GlobalOptions.Instance.InvariantCultureInfo));
        ...
        public string FormattedArea => string.Format(LanguageManager.GetString("Label_SelectAdvancedLifestyle_Base", GlobalOptions.Language),
            BaseArea.ToString(GlobalOptions.Instance.CultureInfo),
            TotalAreaMaximum.ToString(GlobalOptions.Instance.CultureInfo));
        public string FormattedComforts => string.Format(LanguageManager.GetString("Label_SelectAdvancedLifestyle_Base", GlobalOptions.Language),
            BaseComforts.ToString(GlobalOptions.Instance.CultureInfo),
            TotalComfortsMaximum.ToString(GlobalOptions.Instance.CultureInfo));
        public string FormattedSecurity => string.Format(LanguageManager.GetString("Label_SelectAdvancedLifestyle_Base", GlobalOptions.Language),
            BaseSecurity.ToString(GlobalOptions.Instance.CultureInfo),
            TotalSecurityMaximum.ToString(GlobalOptions.Instance.CultureInfo));
        ...
        /// </summary>
        public decimal BaseCostMultiplier => Convert.ToDecimal(LifestyleQualities.Sum(lq => lq.BaseMultiplier) / 100.0m, GlobalOptions.Instance.InvariantCultureInfo);
        ...
        public string DisplayTotalMonthlyCost => TotalMonthlyCost.ToString(_objCharacter.Options.NuyenFormat, GlobalOptions.Instance.CultureInfo) + '¥';
