...
namespace Chummer
{
    ...
    public class StackedFocus
    {
        ...
        public TreeNode CreateTreeNode(Gear objGear, ContextMenuStrip cmsStackedFocus)
        {
            ...
            objNode.Text = LanguageManager.GetString("String_StackedFocus", GlobalOptions.Language) + ':' + LanguageManager.GetString("String_Space", GlobalOptions.Language) + Name(GlobalOptions.Instance.CultureInfo, GlobalOptions.Language);
            objNode.Tag = this;
