    ...
    public class ComplexForm : IHasInternalId, IHasName, IHasXmlNode, IHasNotes, ICanRemove, IHasSource
    {
        ...
        public void Create(XmlNode objXmlComplexFormNode, string strExtra = "")
        {
            ...
            if (string.IsNullOrEmpty(Notes))
            {
                ...
                if (objXmlComplexFormNode.TryGetStringFieldQuickly("nameonpage", ref strNameOnPage) &&
                    ...
                    StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    if (strTranslatedNameOnPage != _strName)
                    {
                        ...
                        if (objXmlComplexFormNode.TryGetStringFieldQuickly("altnameonpage", ref strNameOnPage)
