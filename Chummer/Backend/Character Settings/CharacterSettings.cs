...
namespace Chummer
{
    ...
    public sealed class CharacterSettings : INotifyMultiplePropertiesChangedAsync, IHasName, IHasLockObject
    {
            ...
            await using (await LockObject.EnterWriteLockAsync(token).ConfigureAwait(false))
            {
                ...
                try
                {
                    ...
                    await using (await objOther.LockObject.EnterReadLockAsync(token).ConfigureAwait(false))
                    {
                        ...
                        await using (await objOther._dicCustomDataDirectoryKeys.LockObject.EnterReadLockAsync(token)
                            .ConfigureAwait(false))
                        {
                            token.ThrowIfCancellationRequested();
                            await using (await _dicCustomDataDirectoryKeys.LockObject.EnterUpgradeableReadLockAsync(token).ConfigureAwait(false))
                            {
                                token.ThrowIfCancellationRequested();
                                ...
                                {
                                    lstPropertiesToUpdate.Add(nameof(CustomDataDirectoryKeys));
                                    await using (await _dicCustomDataDirectoryKeys.LockObject.EnterWriteLockAsync(token).ConfigureAwait(false))
                                    {
                                        token.ThrowIfCancellationRequested();
        ...
        public async Task<bool> HasIdenticalSettingsAsync(CharacterSettings objOther, CancellationToken token = default)
        {
            ...
            await using (await objOther.LockObject.EnterReadLockAsync(token).ConfigureAwait(false))
            {
                ...
                await using (await LockObject.EnterReadLockAsync(token).ConfigureAwait(false))
                {
                    ...
                    await using (await objOther._dicCustomDataDirectoryKeys.LockObject.EnterReadLockAsync(token).ConfigureAwait(false))
                    {
                        token.ThrowIfCancellationRequested();
                        await using (await _dicCustomDataDirectoryKeys.LockObject.EnterReadLockAsync(token)
                                .ConfigureAwait(false))
                        {
                            token.ThrowIfCancellationRequested();
                            int intMyCount = await _dicCustomDataDirectoryKeys.GetCountAsync(token)
        ...
        {
            using (LockObject.EnterReadLock(token))
                return GetEquatableHashCodeCommon(token);
        }
        ...
        private int GetEquatableHashCodeCommon(CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            HashCode hashCode = new HashCode();
            hashCode.Add(_guiSourceId);
            hashCode.Add(_strFileName);
            hashCode.Add(_strName);
            hashCode.Add(_blnAllowBiowareSuites);
            hashCode.Add(_blnAllowCyberwareESSDiscounts);
            hashCode.Add(_blnAllowEditPartOfBaseWeapon);
            hashCode.Add(_blnAllowHigherStackedFoci);
            hashCode.Add(_blnAllowInitiationInCreateMode);
            hashCode.Add(_blnDontUseCyberlimbCalculation);
            hashCode.Add(_blnAllowSkillRegrouping);
            hashCode.Add(_blnSpecializationsBreakSkillGroups);
            hashCode.Add(_blnAlternateMetatypeAttributeKarma);
            hashCode.Add(_blnArmorDegradation);
            hashCode.Add(_blnAllowPointBuySpecializationsOnKarmaSkills);
            hashCode.Add(_blnCyberlegMovement);
            hashCode.Add(_blnDontDoubleQualityPurchaseCost);
            hashCode.Add(_blnDontDoubleQualityRefundCost);
            hashCode.Add(_blnEnforceCapacity);
            hashCode.Add(_blnESSLossReducesMaximumOnly);
            hashCode.Add(_blnExceedNegativeQualities);
            hashCode.Add(_blnExceedNegativeQualitiesNoBonus);
            hashCode.Add(_blnExceedPositiveQualities);
            hashCode.Add(_blnExceedPositiveQualitiesCostDoubled);
            hashCode.Add(_blnExtendAnyDetectionSpell);
            hashCode.Add(_blnDroneArmorMultiplierEnabled);
            hashCode.Add(_blnFreeSpiritPowerPointsMAG);
            hashCode.Add(_blnNoArmorEncumbrance);
            hashCode.Add(_blnUncappedArmorAccessoryBonuses);
            hashCode.Add(_blnIgnoreArt);
            hashCode.Add(_blnIgnoreComplexFormLimit);
            hashCode.Add(_blnUnarmedImprovementsApplyToWeapons);
            hashCode.Add(_blnLicenseRestrictedItems);
            hashCode.Add(_blnMaximumArmorModifications);
            hashCode.Add(_blnMetatypeCostsKarma);
            hashCode.Add(_blnMoreLethalGameplay);
            hashCode.Add(_blnMultiplyForbiddenCost);
            hashCode.Add(_blnMultiplyRestrictedCost);
            hashCode.Add(_blnNoSingleArmorEncumbrance);
            hashCode.Add(_blnRestrictRecoil);
            hashCode.Add(_blnSpecialKarmaCostBasedOnShownValue);
            hashCode.Add(_blnSpiritForceBasedOnTotalMAG);
            hashCode.Add(_blnUnrestrictedNuyen);
            hashCode.Add(_blnUseCalculatedPublicAwareness);
            hashCode.Add(_blnUsePointsOnBrokenGroups);
            hashCode.Add(_strContactPointsExpression);
            hashCode.Add(_strKnowledgePointsExpression);
            hashCode.Add(_strChargenKarmaToNuyenExpression);
            hashCode.Add(_strBoundSpiritExpression);
            hashCode.Add(_strRegisteredSpriteExpression);
            hashCode.Add(_strEssenceModifierPostExpression);
            hashCode.Add(_strLiftLimitExpression);
            hashCode.Add(_strCarryLimitExpression);
            hashCode.Add(_strEncumbranceIntervalExpression);
            hashCode.Add(_blnDoEncumbrancePenaltyPhysicalLimit);
            hashCode.Add(_blnDoEncumbrancePenaltyMovementSpeed);
            hashCode.Add(_blnDoEncumbrancePenaltyAgility);
            hashCode.Add(_blnDoEncumbrancePenaltyReaction);
            hashCode.Add(_blnDoEncumbrancePenaltyWoundModifier);
            hashCode.Add(_intEncumbrancePenaltyPhysicalLimit);
            hashCode.Add(_intEncumbrancePenaltyMovementSpeed);
            hashCode.Add(_intEncumbrancePenaltyAgility);
            hashCode.Add(_intEncumbrancePenaltyReaction);
            hashCode.Add(_intEncumbrancePenaltyWoundModifier);
            hashCode.Add(_blnDoNotRoundEssenceInternally);
            hashCode.Add(_blnEnableEnemyTracking);
            hashCode.Add(_blnEnemyKarmaQualityLimit);
            hashCode.Add(_strEssenceFormat);
            hashCode.Add(_intForbiddenCostMultiplier);
            hashCode.Add(_intDroneArmorMultiplier);
            hashCode.Add(_intMetatypeCostMultiplier);
            hashCode.Add(_decNuyenPerBPWftM);
            hashCode.Add(_decNuyenPerBPWftP);
            hashCode.Add(_intRestrictedCostMultiplier);
            hashCode.Add(_blnAutomaticBackstory);
            hashCode.Add(_blnFreeMartialArtSpecialization);
            hashCode.Add(_blnPrioritySpellsAsAdeptPowers);
            hashCode.Add(_blnMysAdeptAllowPpCareer);
            hashCode.Add(_blnMysAdeptSecondMAGAttribute);
            hashCode.Add(_blnReverseAttributePriorityOrder);
            hashCode.Add(_strNuyenFormat);
            hashCode.Add(_strWeightFormat);
            hashCode.Add(_blnCompensateSkillGroupKarmaDifference);
            hashCode.Add(_blnIncreasedImprovedAbilityMultiplier);
            hashCode.Add(_blnAllowFreeGrids);
            hashCode.Add(_blnAllowTechnomancerSchooling);
            hashCode.Add(_blnCyberlimbAttributeBonusCapOverride);
            hashCode.Add(_strBookXPath);
            hashCode.Add(_strExcludeLimbSlot);
            hashCode.Add(_intCyberlimbAttributeBonusCap);
            hashCode.Add(_blnUnclampAttributeMinimum);
            hashCode.Add(_blnDroneMods);
            hashCode.Add(_blnDroneModsMaximumPilot);
            hashCode.Add(_intMaxNumberMaxAttributesCreate);
            hashCode.Add(_intMaxSkillRatingCreate);
            hashCode.Add(_intMaxKnowledgeSkillRatingCreate);
            hashCode.Add(_intMaxSkillRating);
            hashCode.Add(_intMaxKnowledgeSkillRating);
            hashCode.Add(_intMinInitiativeDice);
            hashCode.Add(_intMaxInitiativeDice);
            hashCode.Add(_intMinAstralInitiativeDice);
            hashCode.Add(_intMaxAstralInitiativeDice);
            hashCode.Add(_intMinColdSimInitiativeDice);
            hashCode.Add(_intMaxColdSimInitiativeDice);
            hashCode.Add(_intMinHotSimInitiativeDice);
            hashCode.Add(_intMaxHotSimInitiativeDice);
            hashCode.Add(_intKarmaAttribute);
            hashCode.Add(_intKarmaCarryover);
            hashCode.Add(_intKarmaContact);
            hashCode.Add(_intKarmaEnemy);
            hashCode.Add(_intKarmaEnhancement);
            hashCode.Add(_intKarmaImproveActiveSkill);
            hashCode.Add(_intKarmaImproveKnowledgeSkill);
            hashCode.Add(_intKarmaImproveSkillGroup);
            hashCode.Add(_intKarmaInitiation);
            hashCode.Add(_intKarmaInitiationFlat);
            hashCode.Add(_intKarmaJoinGroup);
            hashCode.Add(_intKarmaLeaveGroup);
            hashCode.Add(_intKarmaTechnique);
            hashCode.Add(_intKarmaMetamagic);
            hashCode.Add(_intKarmaNewActiveSkill);
            hashCode.Add(_intKarmaNewComplexForm);
            hashCode.Add(_intKarmaNewKnowledgeSkill);
            hashCode.Add(_intKarmaNewSkillGroup);
            hashCode.Add(_intKarmaQuality);
            hashCode.Add(_intKarmaSpecialization);
            hashCode.Add(_intKarmaKnoSpecialization);
            hashCode.Add(_intKarmaSpell);
            hashCode.Add(_intKarmaSpirit);
            hashCode.Add(_intKarmaNewAIProgram);
            hashCode.Add(_intKarmaNewAIAdvancedProgram);
            hashCode.Add(_intKarmaMysticAdeptPowerPoint);
            hashCode.Add(_intKarmaSpiritFettering);
            hashCode.Add(_intKarmaAlchemicalFocus);
            hashCode.Add(_intKarmaDisenchantingFocus);
            hashCode.Add(_intKarmaCenteringFocus);
            hashCode.Add(_intKarmaFlexibleSignatureFocus);
            hashCode.Add(_intKarmaMaskingFocus);
            hashCode.Add(_intKarmaSpellShapingFocus);
            hashCode.Add(_intKarmaPowerFocus);
            hashCode.Add(_intKarmaQiFocus);
            hashCode.Add(_intKarmaCounterspellingFocus);
            hashCode.Add(_intKarmaRitualSpellcastingFocus);
            hashCode.Add(_intKarmaSpellcastingFocus);
            hashCode.Add(_intKarmaSustainingFocus);
            hashCode.Add(_intKarmaBanishingFocus);
            hashCode.Add(_intKarmaBindingFocus);
            hashCode.Add(_intKarmaSummoningFocus);
            hashCode.Add(_intKarmaWeaponFocus);
            hashCode.Add(_intDicePenaltySustaining);
            hashCode.Add((int)_eBuildMethod);
            hashCode.Add(_intBuildPoints);
            hashCode.Add(_intQualityKarmaLimit);
            hashCode.Add(_strPriorityArray);
            hashCode.Add(_strPriorityTable);
            hashCode.Add(_intSumtoTen);
            hashCode.Add(_decNuyenMaximumBP);
            hashCode.Add(_intAvailability);
            hashCode.Add(_intMaxMartialArts);
            hashCode.Add(_intMaxMartialTechniques);
            hashCode.Add(_decNuyenCarryover);
            hashCode.Add(_dicCustomDataDirectoryKeys?.GetEnsembleHashCode(token));
            hashCode.Add(_setEnabledCustomDataDirectories?.GetEnsembleHashCode(token) ?? 0);
            hashCode.Add(_setEnabledCustomDataDirectoryGuids?.GetOrderInvariantEnsembleHashCodeSmart(token) ?? 0);
            hashCode.Add(_lstEnabledCustomDataDirectoryPaths?.GetEnsembleHashCode(token) ?? 0);
            hashCode.Add(_setBooks?.GetOrderInvariantEnsembleHashCodeSmart(token) ?? 0);
            hashCode.Add(_setBannedWareGrades?.GetOrderInvariantEnsembleHashCodeSmart(token) ?? 0);
            hashCode.Add(_setRedlinerExcludes?.GetOrderInvariantEnsembleHashCodeSmart(token) ?? 0);
            hashCode.Add(_decKarmaMAGInitiationGroupPercent);
            hashCode.Add(_decKarmaRESInitiationGroupPercent);
            hashCode.Add(_decKarmaMAGInitiationOrdealPercent);
            hashCode.Add(_decKarmaRESInitiationOrdealPercent);
            hashCode.Add(_decKarmaMAGInitiationSchoolingPercent);
            hashCode.Add(_decKarmaRESInitiationSchoolingPercent);
            hashCode.Add(SpecializationBonus);
            hashCode.Add(ExpertiseBonus);
        ...
        private async Task<int> GetEquatableHashCodeCommonAsync(CancellationToken token = default)
        {
            ...
            hashCode.Add(_intMaxMartialTechniques);
            hashCode.Add(_decNuyenCarryover);
            hashCode.Add(_dicCustomDataDirectoryKeys != null ? await _dicCustomDataDirectoryKeys.GetEnsembleHashCodeAsync(token).ConfigureAwait(false) : 0);
            hashCode.Add(_setEnabledCustomDataDirectories?.GetEnsembleHashCode(token) ?? 0);
            hashCode.Add(_setEnabledCustomDataDirectoryGuids?.GetOrderInvariantEnsembleHashCodeSmart(token) ?? 0);
            hashCode.Add(_lstEnabledCustomDataDirectoryPaths?.GetEnsembleHashCode(token) ?? 0);
            hashCode.Add(_setBooks?.GetOrderInvariantEnsembleHashCodeSmart(token) ?? 0);
        ...
        public async Task<bool> LoadAsync(XPathNavigator objXmlNode, CancellationToken token = default)
        {
            ...
            await using (await LockObject.EnterWriteLockAsync(token).ConfigureAwait(false))
            {
                ...
                await using (await _dicCustomDataDirectoryKeys.LockObject.EnterWriteLockAsync(token)
                                                                               .ConfigureAwait(false))
                {
                    token.ThrowIfCancellationRequested();
                    await _dicCustomDataDirectoryKeys.ClearAsync(token).ConfigureAwait(false);
        ...
        public async Task SetMaximumMartialArtsAsync(int value, CancellationToken token = default)
        {
            ...
            await using (await LockObject.EnterUpgradeableReadLockAsync(token).ConfigureAwait(false))
            {
                ...
                await using (await LockObject.EnterWriteLockAsync(token).ConfigureAwait(false))
                {
                    token.ThrowIfCancellationRequested();
                    if (Interlocked.Exchange(ref _intMaxMartialArts, value) != value)
                        await OnPropertyChangedAsync(nameof(MaximumMartialArts), token).ConfigureAwait(false);
                }
            }
        }
        ...
        public async Task SetMaximumMartialTechniquesAsync(int value, CancellationToken token = default)
        {
            ...
            await using (await LockObject.EnterUpgradeableReadLockAsync(token).ConfigureAwait(false))
            {
                ...
                await using (await LockObject.EnterWriteLockAsync(token).ConfigureAwait(false))
                {
                    token.ThrowIfCancellationRequested();
                    if (Interlocked.Exchange(ref _intMaxMartialTechniques, value) != value)
                        await OnPropertyChangedAsync(nameof(MaximumMartialTechniques), token).ConfigureAwait(false);
                }
            }
        }
        ...
        public string ContactPointsExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strContactPointsExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string KnowledgePointsExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strKnowledgePointsExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string ChargenKarmaToNuyenExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strChargenKarmaToNuyenExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string RegisteredSpriteExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strRegisteredSpriteExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string EssenceModifierPostExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strEssenceModifierPostExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string LiftLimitExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strLiftLimitExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string CarryLimitExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strCarryLimitExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public string EncumbranceIntervalExpression
        {
            ...
            set
            {
                ...
                using (LockObject.EnterUpgradeableReadLock())
                {
                    if (_strEncumbranceIntervalExpression == value)
                        return;
                    using (LockObject.EnterWriteLock())
                    {
        ...
        public async Task SetKarmaImproveSkillGroupAsync(int value, CancellationToken token = default)
        {
            ...
            await using (await LockObject.EnterUpgradeableReadLockAsync(token).ConfigureAwait(false))
            {
                ...
                await using (await LockObject.EnterWriteLockAsync(token).ConfigureAwait(false))
                {
                    token.ThrowIfCancellationRequested();
                    if (Interlocked.Exchange(ref _intKarmaImproveSkillGroup, value) != value)
                        await OnPropertyChangedAsync(nameof(KarmaImproveSkillGroup), token).ConfigureAwait(false);
                }
            }
        }
