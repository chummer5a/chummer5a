...
namespace Chummer
{
    public class LockingHashSet<T> : IAsyncSet<T>, IAsyncProducerConsumerCollection<T>, IHasLockObject, IAsyncReadOnlyCollection<T>, IEnumerableWithAsyncAndSideEffects<T>
    {
