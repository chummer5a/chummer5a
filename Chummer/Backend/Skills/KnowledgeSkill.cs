...
namespace Chummer.Backend.Skills
{
    public class KnowledgeSkill : Skill
    {
        ...
        public KnowledgeSkill(Character objCharacter, string strForcedName, bool forcedRating = true) : this(objCharacter)
        {
        ...
        public override void WriteTo(XmlTextWriter objWriter)
        {
            ...
            if (ForcedRating)
                objWriter.WriteElementString("forcedRating", null);
            if (Deletable)
                objWriter.WriteElementString("deletable", null);
        }
