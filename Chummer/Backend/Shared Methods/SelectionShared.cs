...
namespace Chummer.Backend.Shared_Methods
{
    class SelectionShared
    {
        ...
        /// <returns></returns>
        public static bool CheckAvailRestriction(XmlNode objXmlGear, Character objCharacter, bool blnHide, int intRating = 0, int intAvailModifier = 0, bool blnAddToList = true)
        {
            XmlDocument objXmlDocument = new XmlDocument();
