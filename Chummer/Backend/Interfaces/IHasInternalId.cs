...
namespace Chummer
{
    ...
    public static class InternalId
    {
        ...
        public static async Task RefreshChildrenGears(this IHasInternalId objParent, TreeView treGear, ContextMenuStrip cmsGear, ContextMenuStrip cmsCustomGear, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treGear == null)
                return;

            TreeNode nodParent = await treGear.DoThreadSafeFuncAsync(x => x.FindNodeByTag(objParent), token).ConfigureAwait(false);
            if (nodParent == null)
                return;
                ...
                case NotifyCollectionChangedAction.Add:
                    {
                        ...
                        {
                            await AddToTree(objGear, intNewIndex, innerToken: token).ConfigureAwait(false);
                ...
                case NotifyCollectionChangedAction.Remove:
                    {
                        ...
                        {
                            await objGear.SetupChildrenGearsCollectionChangedAsync(false, treGear, token: token).ConfigureAwait(false);
                            await treGear.DoThreadSafeAsync(() => nodParent.FindNodeByTag(objGear)?.Remove(), token).ConfigureAwait(false);
                        }
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        string strSelectedId
                            = (await treGear.DoThreadSafeFuncAsync(x => x.SelectedNode?.Tag, token).ConfigureAwait(false) as IHasInternalId)?.InternalId
                              ?? string.Empty;
                        foreach (Gear objGear in e.OldItems)
                        {
                            await objGear.SetupChildrenGearsCollectionChangedAsync(false, treGear, token: token).ConfigureAwait(false);
            ...
            async ValueTask AddToTree(Gear objGear, int intIndex = -1, bool blnSingleAdd = true, CancellationToken innerToken = default)
            {
                TreeNode objNode = await objGear.CreateTreeNode(cmsGear, cmsCustomGear, innerToken).ConfigureAwait(false);
                if (objNode != null)
                {
                    ...
                    else
                    {
                        await treGear.DoThreadSafeAsync(() =>
                        {
                            ...
                            if (nodLocation != null)
                            {
                                nodLocation.Nodes.AddOrInsert(objNode, intIndex);
                                nodLocation.Expand();
                            }
                    ...
                    if (blnSingleAdd)
                        await treGear.DoThreadSafeAsync(x => x.SelectedNode = objNode, innerToken)
        ...
        public static async Task RefreshChildrenGears(this IHasInternalId objParent, TreeView treGear, ContextMenuStrip cmsGear, ContextMenuStrip cmsCustomGear, Func<CancellationToken, Task<int>> funcOffset, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treGear == null)
                return;
        ...
        public static async Task RefreshChildrenCyberware(this IHasInternalId objParent, TreeView treCyberware, ContextMenuStrip cmsCyberware, ContextMenuStrip cmsCyberwareGear, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treCyberware == null)
                return;

            TreeNode nodParent = await treCyberware.DoThreadSafeFuncAsync(x => x.FindNodeByTag(objParent), token).ConfigureAwait(false);
            if (nodParent == null)
                return;
                ...
                case NotifyCollectionChangedAction.Add:
                    {
                        ...
                        {
                            await AddToTree(objCyberware, intNewIndex, innerToken: token).ConfigureAwait(false);
                ...
                case NotifyCollectionChangedAction.Remove:
                    {
                        ...
                        {
                            await objCyberware.SetupChildrenCyberwareCollectionChangedAsync(false, treCyberware, token: token).ConfigureAwait(false);
                            await treCyberware.DoThreadSafeAsync(() => nodParent.FindNodeByTag(objCyberware)?.Remove(), token).ConfigureAwait(false);
                        }
                    }
                    break;
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        ...
                        await treCyberware.DoThreadSafeAsync(x => x.SelectedNode = x.FindNode(strSelectedId), token).ConfigureAwait(false);
                    }
                    break;

                case NotifyCollectionChangedAction.Move:
                    {
                        string strSelectedId = (await treCyberware.DoThreadSafeFuncAsync(x => x.SelectedNode?.Tag, token).ConfigureAwait(false) as IHasInternalId)?.InternalId ?? string.Empty;
            ...
            async ValueTask AddToTree(Cyberware objCyberware, int intIndex = -1, bool blnSingleAdd = true, CancellationToken innerToken = default)
            {
                TreeNode objNode = await objCyberware.CreateTreeNode(cmsCyberware, cmsCyberwareGear, innerToken).ConfigureAwait(false);
                if (objNode != null)
                {
        ...
        public static async Task RefreshChildrenCyberware(this IHasInternalId objParent, TreeView treCyberware, ContextMenuStrip cmsCyberware, ContextMenuStrip cmsCyberwareGear, Func<CancellationToken, Task<int>> funcOffset, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treCyberware == null)
                return;
        ...
        public static async Task RefreshChildrenWeapons(this IHasInternalId objParent, TreeView treWeapons, ContextMenuStrip cmsWeapon, ContextMenuStrip cmsWeaponAccessory, ContextMenuStrip cmsWeaponAccessoryGear, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treWeapons == null)
                return;

            TreeNode nodParent = await treWeapons.DoThreadSafeFuncAsync(x => x.FindNode(objParent.InternalId), token).ConfigureAwait(false);
            if (nodParent == null)
                return;
                ...
                case NotifyCollectionChangedAction.Add:
                    {
                        ...
                        {
                            await AddToTree(objWeapon, intNewIndex, innerToken: token).ConfigureAwait(false);
                ...
                case NotifyCollectionChangedAction.Remove:
                    {
                        ...
                        {
                            await objWeapon.SetupChildrenWeaponsCollectionChangedAsync(false, treWeapons, token: token).ConfigureAwait(false);
                            await treWeapons.DoThreadSafeAsync(() => nodParent.FindNode(objWeapon.InternalId)?.Remove(), token).ConfigureAwait(false);
                        }
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        ...
                        await treWeapons.DoThreadSafeAsync(x => x.SelectedNode = x.FindNode(strSelectedId), token).ConfigureAwait(false);
                        break;
                    }
                case NotifyCollectionChangedAction.Move:
                    {
            ...
            async ValueTask AddToTree(Weapon objWeapon, int intIndex = -1, bool blnSingleAdd = true, CancellationToken innerToken = default)
            {
                TreeNode objNode = await objWeapon.CreateTreeNode(cmsWeapon, cmsWeaponAccessory, cmsWeaponAccessoryGear, innerToken).ConfigureAwait(false);
                if (objNode != null)
                {
        ...
        public static async Task RefreshChildrenWeapons(this IHasInternalId objParent, TreeView treWeapons, ContextMenuStrip cmsWeapon, ContextMenuStrip cmsWeaponAccessory, ContextMenuStrip cmsWeaponAccessoryGear, Func<CancellationToken, Task<int>> funcOffset, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treWeapons == null)
                return;
        ...
        public static async Task RefreshWeaponAccessoriesClearBindings(this IHasInternalId objParent, TreeView treWeapons, NotifyCollectionChangedEventArgs e, CancellationToken token = default)
        {
            ...
            foreach (WeaponAccessory objWeaponAccessory in e.OldItems)
            {
                ...
                await objWeaponAccessory.GearChildren.ForEachWithSideEffectsAsync((objGear, t) => objGear.SetupChildrenGearsCollectionChangedAsync(false, treWeapons, token: t), token).ConfigureAwait(false);
            }
        }

        public static async Task RefreshWeaponAccessories(this IHasInternalId objParent, TreeView treWeapons, ContextMenuStrip cmsWeaponAccessory, ContextMenuStrip cmsWeaponAccessoryGear, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treWeapons == null)
                return;
                ...
                case NotifyCollectionChangedAction.Add:
                    {
                        ...
                        foreach (WeaponAccessory objWeaponAccessory in e.NewItems)
                        {
                            ...
                            await objWeaponAccessory.GearChildren.ForEachWithSideEffectsAsync((objGear, t) =>
                                objGear.SetupChildrenGearsCollectionChangedAsync(true, treWeapons, cmsWeaponAccessoryGear, null, funcMakeDirty, t), token).ConfigureAwait(false);
                            ++intNewIndex;
                        }
                ...
                case NotifyCollectionChangedAction.Remove:
                    {
                        foreach (WeaponAccessory objWeaponAccessory in e.OldItems)
                        {
                            ...
                            await objWeaponAccessory.GearChildren.ForEachWithSideEffectsAsync((objGear, t) => objGear.SetupChildrenGearsCollectionChangedAsync(false, treWeapons, token: t), token).ConfigureAwait(false);
                            await treWeapons.DoThreadSafeAsync(
                                () => nodParent.FindNode(objWeaponAccessory.InternalId)?.Remove(), token).ConfigureAwait(false);
                        }
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        ...
                        foreach (WeaponAccessory objWeaponAccessory in e.NewItems)
                        {
                            ...
                            if (funcMakeDirty != null)
                                objWeaponAccessory.GearChildren.AddTaggedCollectionChanged(treWeapons, funcMakeDirty);
                            await objWeaponAccessory.GearChildren.ForEachWithSideEffectsAsync((objGear, t) => objGear.SetupChildrenGearsCollectionChangedAsync(true, treWeapons, cmsWeaponAccessoryGear, null, funcMakeDirty, t), token).ConfigureAwait(false);
                            ++intNewIndex;
                        }
            ...
            async ValueTask AddToTree(WeaponAccessory objWeaponAccessory, int intIndex = -1, bool blnSingleAdd = true, CancellationToken innerToken = default)
            {
                TreeNode objNode = await objWeaponAccessory.CreateTreeNode(cmsWeaponAccessory, cmsWeaponAccessoryGear, innerToken).ConfigureAwait(false);
                if (objNode != null)
                {
                    await treWeapons.DoThreadSafeAsync(x =>
                    {
        ...
        public static async Task RefreshWeaponAccessories(this IHasInternalId objParent, TreeView treWeapons, ContextMenuStrip cmsWeaponAccessory, ContextMenuStrip cmsWeaponAccessoryGear, [NotNull] Func<CancellationToken, Task<int>> funcOffset, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (e == null || objParent == null || treWeapons == null)
                return;
        ...
        public static async Task RefreshVehicleModsClearBindings(this IHasInternalId objParent, TreeView treVehicles, NotifyCollectionChangedEventArgs e, CancellationToken token = default)
        {
            ...
            foreach (VehicleMod objVehicleMod in e.OldItems)
            {
                ...
                await objVehicleMod.Cyberware.ForEachWithSideEffectsAsync((objCyberware, t) => objCyberware.SetupChildrenCyberwareCollectionChangedAsync(false, treVehicles, token: t), token).ConfigureAwait(false);
                ...
                await objVehicleMod.Weapons.ForEachWithSideEffectsAsync((objWeapon, t) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(false, treVehicles, token: t), token).ConfigureAwait(false);
            }
        }

        public static async Task RefreshVehicleMods(this IHasInternalId objParent, TreeView treVehicles, ContextMenuStrip cmsVehicleMod, ContextMenuStrip cmsCyberware, ContextMenuStrip cmsCyberwareGear, ContextMenuStrip cmsVehicleWeapon, ContextMenuStrip cmsVehicleWeaponAccessory, ContextMenuStrip cmsVehicleWeaponAccessoryGear, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (treVehicles == null || e == null)
                return;

            TreeNode nodParent = await treVehicles.DoThreadSafeFuncAsync(x => x.FindNodeByTag(objParent), token).ConfigureAwait(false);
            if (nodParent == null)
                return;
            ...
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    {
                        ...
                        foreach (VehicleMod objVehicleMod in e.NewItems)
                        {
                            ...
                            await objVehicleMod.Cyberware.ForEachWithSideEffectsAsync((objCyberware, t) => objCyberware.SetupChildrenCyberwareCollectionChangedAsync(true, treVehicles, cmsCyberware, cmsCyberwareGear, funcMakeDirty, t), token).ConfigureAwait(false);
                            await objVehicleMod.Weapons.ForEachWithSideEffectsAsync((objWeapon, t) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(true, treVehicles, cmsVehicleWeapon, cmsVehicleWeaponAccessory, cmsVehicleWeaponAccessoryGear, funcMakeDirty, t), token).ConfigureAwait(false);
                            ++intNewIndex;
                        }
                    }
                    break;
                ...
                case NotifyCollectionChangedAction.Remove:
                    {
                        foreach (VehicleMod objVehicleMod in e.OldItems)
                        {
                            ...
                            await objVehicleMod.Weapons.RemoveTaggedAsyncCollectionChangedAsync(treVehicles, token).ConfigureAwait(false);
                            await objVehicleMod.Weapons.ForEachWithSideEffectsAsync((objWeapon, t) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(false, treVehicles, token: t), token).ConfigureAwait(false);
                            await treVehicles.DoThreadSafeAsync(() => RemoveModNode(objVehicleMod), token).ConfigureAwait(false);
                        }
                    }
                    break;
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        string strSelectedId = (await treVehicles.DoThreadSafeFuncAsync(x => x.SelectedNode?.Tag, token).ConfigureAwait(false) as IHasInternalId)?.InternalId ?? string.Empty;
                        foreach (VehicleMod objVehicleMod in e.OldItems)
                        {
                            await objVehicleMod.Cyberware.RemoveTaggedAsyncCollectionChangedAsync(treVehicles, token).ConfigureAwait(false);
                            await objVehicleMod.Cyberware.ForEachWithSideEffectsAsync((objCyberware, t) => objCyberware.SetupChildrenCyberwareCollectionChangedAsync(false, treVehicles, token: t), token).ConfigureAwait(false);
                        ...
                        await treVehicles.DoThreadSafeAsync(x => x.SelectedNode = x.FindNode(strSelectedId), token).ConfigureAwait(false);
                    }
                    break;
                ...
                case NotifyCollectionChangedAction.Move:
                    {
                        string strSelectedId
                            = (await treVehicles.DoThreadSafeFuncAsync(x => x.SelectedNode?.Tag, token).ConfigureAwait(false) as IHasInternalId)?.InternalId ?? string.Empty;
                        await treVehicles.DoThreadSafeAsync(() =>
                        {
                            foreach (VehicleMod objVehicleMod in e.OldItems)
                            {
                                RemoveModNode(objVehicleMod);
                            }
                        }, token).ConfigureAwait(false);
                        int intNewIndex = e.NewStartingIndex;
                        foreach (VehicleMod objVehicleMod in e.NewItems)
                        {
                            await AddToTree(objVehicleMod, intNewIndex, blnSkipAlphabetize: true, innerToken: token).ConfigureAwait(false);
                            ++intNewIndex;
                        }
                ...
                case NotifyCollectionChangedAction.Reset:
                    {
                        await treVehicles.DoThreadSafeAsync(() =>
                        {
                            for (int i = nodParent.Nodes.Count - 1; i >= 0; --i)
                            {
                                ...
                                else if (VehicleMod.IsCategoryGroupTag(objNode.Tag))
                                {
                                    for (int j = objNode.Nodes.Count - 1; j >= 0; --j)
                                    {
                                        TreeNode objChild = objNode.Nodes[j];
                                        if (objChild.Tag is VehicleMod objChildMod
                                            && !ReferenceEquals(objChildMod.Parent, objParent)
                                            && !ReferenceEquals(objChildMod.WeaponMountParent, objParent))
                                        {
                                            objChild.Remove();
                                        }
                                    }
            ...
            void RemoveModNode(VehicleMod objVehicleMod)
            {
                ...
                if (objCategoryNode != null
                    && !ReferenceEquals(objCategoryNode, nodParent)
                    && VehicleMod.IsCategoryGroupTag(objCategoryNode.Tag)
            ...
            async ValueTask AddToTree(VehicleMod objVehicleMod, int intIndex = -1, bool blnSingleAdd = true,
                                      bool blnSkipAlphabetize = false, CancellationToken innerToken = default)
            {
                TreeNode objNode = await objVehicleMod.CreateTreeNode(cmsVehicleMod, cmsCyberware, cmsCyberwareGear, cmsVehicleWeapon, cmsVehicleWeaponAccessory, cmsVehicleWeaponAccessoryGear, innerToken).ConfigureAwait(false);
                if (objNode == null)
                    return;

                TreeNode nodDestination = nodParent;
                if (GlobalSettings.GroupVehicleModsByCategory)
                {
                    string strCategoryTag = VehicleMod.GetCategoryGroupTag(objVehicleMod.Category);
                    nodDestination = await treVehicles.DoThreadSafeFuncAsync(() => nodParent.FindNode(strCategoryTag, false), innerToken).ConfigureAwait(false);
                    if (nodDestination == null)
                    {
                        nodDestination = await objVehicleMod.CreateCategoryGroupTreeNode(innerToken).ConfigureAwait(false);
                        string strCategoryKey = VehicleMod.GetCategoryGroupKey(objVehicleMod.Category);
                        await treVehicles.DoThreadSafeAsync(() =>
                        {
                            int intInsert = GetCategoryGroupInsertIndex(nodParent, strCategoryKey, intIndex);
                            if (intInsert >= 0 && intInsert <= nodParent.Nodes.Count)
                                nodParent.Nodes.Insert(intInsert, nodDestination);
                            else
                                nodParent.Nodes.Add(nodDestination);
                        }, innerToken).ConfigureAwait(false);
                    }
                }
                ...
                await treVehicles.DoThreadSafeAsync(x =>
                {
                    ...
                    nodDestination.Nodes.AddOrInsert(objNode, intIndex, blnSkipAlphabetize);
                    nodDestination.Expand();
                    if (blnSingleAdd)
                        x.SelectedNode = objNode;
                }, innerToken).ConfigureAwait(false);
            }

            int GetCategoryGroupInsertIndex(TreeNode nodVehicleOrMount, string strCategoryKey, int intSuggestedIndex)
            {
                int intCategoryOrder = VehicleMod.GetCategoryGroupSortOrder(strCategoryKey);
                int intInsertBefore = -1;
                int intLastModRelated = -1;

                for (int i = 0; i < nodVehicleOrMount.Nodes.Count; ++i)
                {
                    object objTag = nodVehicleOrMount.Nodes[i].Tag;
                    if (objTag is Location)
                        continue;

                    if (VehicleMod.IsCategoryGroupTag(objTag))
                    {
                        string strExistingTag = (string)objTag;
                        string strExistingKey = strExistingTag.Substring(VehicleMod.CategoryGroupTagPrefix.Length);
                        if (VehicleMod.GetCategoryGroupSortOrder(strExistingKey) > intCategoryOrder
                            && intInsertBefore < 0)
                        {
                            intInsertBefore = i;
                        }
                    ...
                    else if (objTag is VehicleMod)
                    {
                        intLastModRelated = i;
                    }
                    else if (objTag is string strTag && strTag == "String_WeaponMounts")
                    {
                        return intInsertBefore >= 0 ? intInsertBefore : i;
                    }
                    else if (objTag is Weapon || objTag is Gear)
                    {
                        return intInsertBefore >= 0
                            ? intInsertBefore
                            : intLastModRelated >= 0 ? intLastModRelated + 1 : i;
                    }
                }

                if (intInsertBefore >= 0)
                    return intInsertBefore;
                if (intLastModRelated >= 0)
                    return intLastModRelated + 1;
                // Fall back after any leading Location nodes
                int intAfterLocations = 0;
                for (int i = 0; i < nodVehicleOrMount.Nodes.Count; ++i)
                {
                    if (nodVehicleOrMount.Nodes[i].Tag is Location)
                        intAfterLocations = i + 1;
                }

                return intSuggestedIndex >= intAfterLocations ? intSuggestedIndex : intAfterLocations;
            }
        }
        ...
        public static async Task RefreshVehicleMods(this IHasInternalId objParent, TreeView treVehicles, ContextMenuStrip cmsVehicleMod, ContextMenuStrip cmsCyberware, ContextMenuStrip cmsCyberwareGear, ContextMenuStrip cmsVehicleWeapon, ContextMenuStrip cmsVehicleWeaponAccessory, ContextMenuStrip cmsVehicleWeaponAccessoryGear, Func<CancellationToken, Task<int>> funcOffset, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (treVehicles == null || e == null)
                return;
        ...
        public static async Task RefreshVehicleWeaponMountsClearBindings(this IHasInternalId objParent, TreeView treVehicles, NotifyCollectionChangedEventArgs e, CancellationToken token = default)
        {
            ...
            foreach (WeaponMount objWeaponMount in e.OldItems)
            {
                ...
                await objWeaponMount.Weapons.ForEachWithSideEffectsAsync((objWeapon, t) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(false, treVehicles, token: t), token).ConfigureAwait(false);
                await objWeaponMount.Mods.ForEachWithSideEffectsAsync(async (objMod, t1) =>
                {
                    await objMod.Cyberware.RemoveTaggedAsyncBeforeClearCollectionChangedAsync(treVehicles, t1).ConfigureAwait(false);
                    await objMod.Cyberware.RemoveTaggedAsyncCollectionChangedAsync(treVehicles, t1)
                        .ConfigureAwait(false);
                    await objMod.Cyberware.ForEachWithSideEffectsAsync(
                        (objCyberware, t2) =>
                            objCyberware.SetupChildrenCyberwareCollectionChangedAsync(false, treVehicles,
                                token: t2), t1).ConfigureAwait(false);
                    await objMod.Weapons.RemoveTaggedAsyncBeforeClearCollectionChangedAsync(treVehicles, t1).ConfigureAwait(false);
                    await objMod.Weapons.RemoveTaggedAsyncCollectionChangedAsync(treVehicles, t1)
                        .ConfigureAwait(false);
        ...
        public static async Task RefreshVehicleWeaponMounts(this IHasInternalId objParent, TreeView treVehicles, ContextMenuStrip cmsVehicleWeaponMount, ContextMenuStrip cmsVehicleWeapon, ContextMenuStrip cmsVehicleWeaponAccessory, ContextMenuStrip cmsVehicleWeaponAccessoryGear, ContextMenuStrip cmsCyberware, ContextMenuStrip cmsCyberwareGear, ContextMenuStrip cmsVehicleMod, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (treVehicles == null || e == null)
                return;

            TreeNode nodVehicleParent = await treVehicles.DoThreadSafeFuncAsync(x => x.FindNodeByTag(objParent), token).ConfigureAwait(false);
            if (nodVehicleParent == null)
                return;
            TreeNode nodParent = await treVehicles.DoThreadSafeFuncAsync(() =>
            {
                TreeNode nodMounts = nodVehicleParent.FindNode("String_WeaponMounts", false);
                if (nodMounts != null)
                    return nodMounts;
                if (!VehicleMod.ShouldNestWeaponMountsUnderWeaponsCategory)
                    return null;
                TreeNode nodWeapons = nodVehicleParent.FindNode(
                    VehicleMod.GetCategoryGroupTag(VehicleMod.WeaponsCategoryKey), false);
                return nodWeapons?.FindNode("String_WeaponMounts", false);
            }, token).ConfigureAwait(false);
                        ...
                        foreach (WeaponMount objWeaponMount in e.NewItems)
                        {
                            ...
                            Task FuncWeaponMountWeaponToAdd(object x, NotifyCollectionChangedEventArgs y,
                                ...
                                objWeaponMount.RefreshChildrenWeapons(
                                    treVehicles, cmsVehicleWeapon, cmsVehicleWeaponAccessory,
                                    cmsVehicleWeaponAccessoryGear, t => objWeaponMount.Mods.GetCountAsync(t), y, funcMakeDirty,
                                    token: innerToken);
                            ...
                            await objWeaponMount.Weapons
                                .ForEachWithSideEffectsAsync(
                                    (objWeapon, t) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(true, treVehicles,
                            ...
                            await objWeaponMount.Mods.ForEachWithSideEffectsAsync(async (objMod, t1) =>
                            {
                                ...
                                Task FuncWeaponMountVehicleModWeaponsToAdd(
                                    ...
                                    objMod.RefreshChildrenWeapons(treVehicles, cmsVehicleWeapon,
                                        ...
                                        t => objMod.Cyberware.GetCountAsync(t), y, funcMakeDirty, token: innerToken);
                                ...
                                await objMod.Cyberware.ForEachWithSideEffectsAsync(
                                        (objCyberware, t2) => objCyberware.SetupChildrenCyberwareCollectionChangedAsync(true,
                                            treVehicles, cmsCyberware, cmsCyberwareGear, funcMakeDirty, t2), t1)
                                    .ConfigureAwait(false);
                                await objMod.Weapons.ForEachWithSideEffectsAsync(
                                    (objWeapon, t2) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(true, treVehicles,
                                        cmsVehicleWeapon, cmsVehicleWeaponAccessory, cmsVehicleWeaponAccessoryGear,
                                        funcMakeDirty, t2), t1).ConfigureAwait(false);
                            }, token).ConfigureAwait(false);
                            ++intNewIndex;
                        }
                    }
                        ...
                        foreach (WeaponMount objWeaponMount in e.OldItems)
                        {
                            ...
                            if (nodParent != null)
                            {
                                await treVehicles.DoThreadSafeAsync(() =>
                                {
                                    ...
                                    {
                                        TreeNode nodWeaponsCategory = nodParent.Parent;
                                        nodParent.Remove();
                                        if (nodWeaponsCategory != null
                                            && VehicleMod.IsCategoryGroupTag(nodWeaponsCategory.Tag)
                                            && nodWeaponsCategory.Nodes.Count == 0)
                                        {
                                            nodWeaponsCategory.Remove();
                                        }
                                    }
                                }, token).ConfigureAwait(false);
                            }
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        ...
                        foreach (WeaponMount objWeaponMount in e.OldItems)
                        {
                            ...
                            await treVehicles.DoThreadSafeAsync(() => nodParent?.FindNodeByTag(objWeaponMount)?.Remove(), token).ConfigureAwait(false);
                        }
                        int intNewIndex = e.NewStartingIndex;
                        foreach (WeaponMount objWeaponMount in e.NewItems)
                        {
                            ...
                            await objWeaponMount.Mods.ForEachWithSideEffectsAsync(async (objMod, t1) =>
                            {
                                ...
                                await objMod.Cyberware.ForEachWithSideEffectsAsync(
                                    (objCyberware, t2) => objCyberware.SetupChildrenCyberwareCollectionChangedAsync(true,
                                        treVehicles, cmsCyberware, cmsCyberwareGear, funcMakeDirty, t2), t1).ConfigureAwait(false);
                                await objMod.Weapons.ForEachWithSideEffectsAsync(
                                    (objWeapon, t2) => objWeapon.SetupChildrenWeaponsCollectionChangedAsync(true, treVehicles,
                                        cmsVehicleWeapon, cmsVehicleWeaponAccessory, cmsVehicleWeaponAccessoryGear,
                                        funcMakeDirty, t2), t1).ConfigureAwait(false);
                ...
                case NotifyCollectionChangedAction.Move:
                    {
                        ...
                        foreach (WeaponMount objWeaponMount in e.NewItems)
                        {
                            await AddToTree(objWeaponMount, intNewIndex, blnSkipAlphabetize: true, innerToken: token).ConfigureAwait(false);
                            ++intNewIndex;
                        }
                        await treVehicles.DoThreadSafeAsync(x => x.SelectedNode = x.FindNode(strSelectedId), token).ConfigureAwait(false);
                    }
            ...
            async ValueTask AddToTree(WeaponMount objWeaponMount, int intIndex = -1, bool blnSingleAdd = true,
                                      bool blnSkipAlphabetize = false, CancellationToken innerToken = default)
            {
                TreeNode objNode = await objWeaponMount.CreateTreeNode(cmsVehicleWeaponMount, cmsVehicleWeapon, cmsVehicleWeaponAccessory, cmsVehicleWeaponAccessoryGear, cmsCyberware, cmsCyberwareGear, cmsVehicleMod, innerToken).ConfigureAwait(false);
                if (objNode == null)
                    return;
                ...
                if (nodParent == null)
                {
                    nodParent = new TreeNode
                    {
                        ...
                        Text = await LanguageManager.GetStringAsync("String_WeaponMounts", token: innerToken).ConfigureAwait(false)
                    };

                    Character objCharacter = (objParent as IHasCharacterObject)?.CharacterObject;
                    ...
                    if (VehicleMod.ShouldNestWeaponMountsUnderWeaponsCategory)
                    {
                        ...
                        nodWeaponsCategory = await treVehicles.DoThreadSafeFuncAsync(
                            () => nodVehicleParent.FindNode(strWeaponsTag, false), innerToken).ConfigureAwait(false)
                            ?? new TreeNode
                            {
                                Tag = strWeaponsTag,
                                Text = await VehicleMod.GetCategoryGroupDisplayNameAsync(
                                    VehicleMod.WeaponsCategoryKey, objCharacter, innerToken).ConfigureAwait(false)
                            };
                    }
                    ...
                    await treVehicles.DoThreadSafeAsync(() =>
                    {
                        if (nodWeaponsCategory != null)
                        {
                            if (nodWeaponsCategory.TreeView == null && nodWeaponsCategory.Parent == null)
                            {
                                int intCategoryInsert = GetCategoryGroupInsertIndexForMounts(nodVehicleParent);
                                if (intCategoryInsert >= 0 && intCategoryInsert <= nodVehicleParent.Nodes.Count)
                                    nodVehicleParent.Nodes.Insert(intCategoryInsert, nodWeaponsCategory);
                                else
                                    nodVehicleParent.Nodes.Add(nodWeaponsCategory);
                            }

                            nodWeaponsCategory.Nodes.Add(nodParent);
                            nodWeaponsCategory.Expand();
                        }
                        else
                        {
                            int intInsert = GetWeaponMountsFolderInsertIndex(nodVehicleParent);
                            if (intInsert >= 0 && intInsert <= nodVehicleParent.Nodes.Count)
                                nodVehicleParent.Nodes.Insert(intInsert, nodParent);
                            else
                                nodVehicleParent.Nodes.Add(nodParent);
                        }
                ...
                await treVehicles.DoThreadSafeAsync(x =>
                {
                    if (nodParent == null)
                        return;
                    nodParent.Nodes.AddOrInsert(objNode, intIndex, blnSkipAlphabetize);
                    nodParent.Expand();
                    if (blnSingleAdd)
                        x.SelectedNode = objNode;
                }, innerToken).ConfigureAwait(false);
            ...
            int GetCategoryGroupInsertIndexForMounts(TreeNode nodVehicle)
            {
                int intWeaponsOrder = VehicleMod.GetCategoryGroupSortOrder(VehicleMod.WeaponsCategoryKey);
                int intInsertBefore = -1;
                int intLastCategory = -1;
                for (int i = 0; i < nodVehicle.Nodes.Count; ++i)
                {
                    object objTag = nodVehicle.Nodes[i].Tag;
                    if (VehicleMod.IsCategoryGroupTag(objTag))
                    {
                        string strKey = ((string)objTag).Substring(VehicleMod.CategoryGroupTagPrefix.Length);
                        if (VehicleMod.GetCategoryGroupSortOrder(strKey) > intWeaponsOrder && intInsertBefore < 0)
                            intInsertBefore = i;
                        intLastCategory = i;
                    }
                    else if (objTag is VehicleMod)
                    ...
                    else if (objTag is Location)
                    {
                        continue;
                    }
                    else if (objTag is Weapon || objTag is Gear || (objTag is string str && str == "String_WeaponMounts"))
                    {
                        return intInsertBefore >= 0 ? intInsertBefore : (intLastCategory >= 0 ? intLastCategory + 1 : i);
                    }
                }

                if (intInsertBefore >= 0)
                    return intInsertBefore;
                if (intLastCategory >= 0)
                    return intLastCategory + 1;
                return GetWeaponMountsFolderInsertIndex(nodVehicle);
            }

            int GetWeaponMountsFolderInsertIndex(TreeNode nodVehicle)
            {
                int intLastModRelated = -1;
                for (int i = 0; i < nodVehicle.Nodes.Count; ++i)
                {
                    ...
                    if (objTag is Location)
                        continue;
                    if (objTag is VehicleMod || VehicleMod.IsCategoryGroupTag(objTag))
                        intLastModRelated = i;
                    else if (objTag is Weapon || objTag is Gear)
                        return intLastModRelated >= 0 ? intLastModRelated + 1 : i;
                }
                ...
                for (int i = 0; i < nodVehicle.Nodes.Count; ++i)
                {
                    if (nodVehicle.Nodes[i].Tag is Location)
                        intAfterLocations = i + 1;
                }

                return intAfterLocations;
            }
        }
        ...
        public static async Task RefreshVehicleWeaponMounts(this IHasInternalId objParent, TreeView treVehicles, ContextMenuStrip cmsVehicleWeaponMount, ContextMenuStrip cmsVehicleWeapon, ContextMenuStrip cmsVehicleWeaponAccessory, ContextMenuStrip cmsVehicleWeaponAccessoryGear, ContextMenuStrip cmsCyberware, ContextMenuStrip cmsCyberwareGear, ContextMenuStrip cmsVehicleMod, Func<CancellationToken, Task<int>> funcOffset, NotifyCollectionChangedEventArgs e, AsyncNotifyCollectionChangedEventHandler funcMakeDirty, CancellationToken token = default)
        {
            if (treVehicles == null || e == null)
                return;
