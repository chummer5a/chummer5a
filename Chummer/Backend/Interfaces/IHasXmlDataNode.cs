...
namespace Chummer
{
    ...
    public static class HasXmlDataNode
    {
        ...
        {
            return Utils.SafelyRunSynchronously(t => objThis.GetNodeXPathCoreAsync(true, GlobalSettings.DefaultLanguage, t), token);
        }
        ...
        {
            return Utils.SafelyRunSynchronously(t => objThis.GetNodeXPathCoreAsync(true, strLanguage, t), token);
        }
        ...
        {
            return Utils.SafelyRunSynchronously(t => objThis.GetNodeCoreAsync(true, GlobalSettings.DefaultLanguage, t), token);
        }
        ...
        {
            return Utils.SafelyRunSynchronously(t => objThis.GetNodeCoreAsync(true, strLanguage, t), token);
        }
