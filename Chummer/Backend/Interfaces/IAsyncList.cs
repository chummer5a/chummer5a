...
namespace Chummer
{
    ...
    public static class AsyncListExtensions
    {
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Action<T, T, CancellationToken> funcOverrideIfEquals,
                                                     CancellationToken token = default) where T : IComparable
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Comparison<T> funcComparison, Action<T, T, CancellationToken> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddRangeWithSortAsync<T>(this IAsyncList<T> lstCollection, IEnumerable<T> lstToAdd,
                                                          IComparer<T> comparer, Action<T, T, CancellationToken> funcOverrideIfEquals,
                                                          CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, CancellationToken, Task> funcOverrideIfEquals,
                                                     CancellationToken token = default) where T : IComparable
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
            ...
            try
            {
                     ...
                     intTargetIndex = (intIntervalStart + intIntervalEnd) / 2)
                {
                    ...
                    if (intCompareResult == 0)
                    {
                        ...
                        if (funcOverrideIfEquals != null)
                        {
                            await funcOverrideIfEquals.Invoke(objLoopExistingItem, objNewItem, token).ConfigureAwait(false);
                            return;
                        }
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Comparison<T> funcComparison, Func<T, T, CancellationToken, Task> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, CancellationToken, Task<int>> funcComparison, Action<T, T> funcOverrideIfEquals = null,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
            ...
            try
            {
                     ...
                     intTargetIndex = (intIntervalStart + intIntervalEnd) / 2)
                {
                    T objLoopExistingItem
                        = await lstCollection.GetValueAtAsync(intTargetIndex, token).ConfigureAwait(false);
                    int intCompareResult = await funcComparison(objLoopExistingItem, objNewItem, token).ConfigureAwait(false);
                    if (intCompareResult == 0)
                    {
                        // Make sure we insert new items at the end of any equalities (so that order is maintained when adding multiple items)
                        for (int i = intTargetIndex + 1;
                             ...
                             ++i)
                        {
                            T objInnerLoopExistingItem
                                = await lstCollection.GetValueAtAsync(i, token).ConfigureAwait(false);
                            if (await funcComparison(objInnerLoopExistingItem, objNewItem, token).ConfigureAwait(false) == 0)
                            {
                                ++intTargetIndex;
                                objLoopExistingItem = objInnerLoopExistingItem;
                            }
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, Task<int>> funcComparison, Action<T, T, CancellationToken> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
            ...
            try
            {
                     ...
                     intTargetIndex = (intIntervalStart + intIntervalEnd) / 2)
                {
                    ...
                    if (intCompareResult == 0)
                    {
                        ...
                        if (funcOverrideIfEquals != null)
                        {
                            funcOverrideIfEquals(objLoopExistingItem, objNewItem, token);
                            return;
                        }
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, CancellationToken, Task<int>> funcComparison, Action<T, T, CancellationToken> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, CancellationToken, Task<int>> funcComparison, Func<T, T, Task> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, Task<int>> funcComparison, Func<T, T, CancellationToken, Task> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddWithSortAsync<T>(this IAsyncList<T> lstCollection, T objNewItem,
                                                     Func<T, T, CancellationToken, Task<int>> funcComparison, Func<T, T, CancellationToken, Task> funcOverrideIfEquals,
                                                     CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddRangeWithSortAsync<T>(this IAsyncList<T> lstCollection, IEnumerable<T> lstToAdd,
                                                          IComparer<T> comparer, Func<T, T, CancellationToken, Task> funcOverrideIfEquals,
                                                          CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
        ...
        public static async Task AddRangeWithSortAsync<T>(this IAsyncList<T> lstCollection, IEnumerable<T> lstToAdd,
                                                          Func<T, T, CancellationToken, Task<int>> funcComparison,
                                                          Action<T, T> funcOverrideIfEquals = null,
                                                          CancellationToken token = default)
        {
            if (lstCollection == null)
        ...
        public static async Task RemoveAllAsync<T>(this IAsyncList<T> lstCollection, Func<T, CancellationToken, Task<bool>> predicate,
                                              CancellationToken token = default)
        {
            if (lstCollection == null)
                throw new ArgumentNullException(nameof(lstCollection));
            ...
            try
            {
                ...
                for (int i = await lstCollection.GetCountAsync(token).ConfigureAwait(false) - 1; i >= 0; --i)
                {
                    if (await predicate.Invoke(await lstCollection.GetValueAtAsync(i, token).ConfigureAwait(false), token)
                                       .ConfigureAwait(false))
                    {
                        await lstCollection.RemoveAtAsync(i, token).ConfigureAwait(false);
                    }
        ...
        public static async Task SortAsync<T>(this IAsyncList<T> lstCollection, Func<T, T, CancellationToken, Task<int>> comparer,
            CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            if (lstCollection == null)
        ...
        private static async Task SwapIfGreaterAsync<T>(this IAsyncList<T> lstCollection, Func<T, T, CancellationToken, Task<int>> comparer,
            int a, int b, CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            if (a != b)
            {
                T lhs = await lstCollection.GetValueAtAsync(a, token).ConfigureAwait(false);
                T rhs = await lstCollection.GetValueAtAsync(b, token).ConfigureAwait(false);
                if (await comparer(lhs, rhs, token).ConfigureAwait(false) > 0)
                {
                    await lstCollection.SetValueAtAsync(a, rhs, token).ConfigureAwait(false);
                    await lstCollection.SetValueAtAsync(b, lhs, token).ConfigureAwait(false);
                }
            ...
            Func<T, T, CancellationToken, Task<int>> comparer, CancellationToken token = default)
        {
            ...
            while (i < j)
            {
                ...
                {
                    ++i;
                } while (await comparer(await lstCollection.GetValueAtAsync(i, token).ConfigureAwait(false), key, token)
                             .ConfigureAwait(false) < 0);

                do
                {
                    --j;
                } while (await comparer(key, await lstCollection.GetValueAtAsync(j, token).ConfigureAwait(false), token)
                             .ConfigureAwait(false) < 0);
            ...
            Func<T, T, CancellationToken, Task<int>> comparer, CancellationToken token = default)
        {
            ...
            for (; i <= n / 2; i = num)
            {
                ...
                {
                    T key3 = await lstCollection.GetValueAtAsync(lo + num, token).ConfigureAwait(false);
                    if (await comparer(key2, key3, token).ConfigureAwait(false) < 0)
                        key2 = key3;
                }

                if (await comparer(key, key2, token).ConfigureAwait(false) < 0)
                    await lstCollection.SetValueAtAsync(lo + i - 1, key2, token).ConfigureAwait(false);
                else
                    break;
            }
            ...
            Func<T, T, CancellationToken, Task<int>> comparer, CancellationToken token = default)
        {
            ...
            for (int index1 = lo; index1 < hi; ++index1)
            {
                ...
                {
                    for (T key2 = await lstCollection.GetValueAtAsync(index2, token).ConfigureAwait(false);
                         await comparer(key, key2, token).ConfigureAwait(false) < 0;
                         key2 = await lstCollection.GetValueAtAsync(index2, token).ConfigureAwait(false))
                    {
                        token.ThrowIfCancellationRequested();
                        await lstCollection.SetValueAtAsync(index2 + 1, key2, token)
