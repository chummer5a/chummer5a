...
namespace Chummer
{
    public partial class frmDiceHits : Form
    {
        ...
        {
            lblDice.Text = LanguageManager.GetString("String_DiceHits_HitsOn", GlobalOptions.Language) + ' ' + _intDice.ToString() + LanguageManager.GetString("String_D6", GlobalOptions.Language) + ": ";
