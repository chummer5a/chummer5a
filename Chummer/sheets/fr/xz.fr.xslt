...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="lang.Comforts"		select="'Confort'"/>
	...
	<xsl:variable name="lang.Entertainment"	select="'Divertissements'"/>
	...
	<xsl:variable name="lang.Necessities"	select="'Nécessités'"/>
	<xsl:variable name="lang.Neighborhood"	select="'Quartier'"/>
	...
	<xsl:variable name="lang.Security"		select="'Sécurité'"/>
