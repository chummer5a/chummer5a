						...
						<table width="650px" cellspacing="0" cellpadding="0" border="0">
							...
							<tr>
								...
								<td width="50%" colspan="2" rowspan="6" valign="top" class="tableborder">
									<xsl:choose>
											...
											<table width="100%">
												<tr>
													<td width="50%" style="text-align:center;">
														<strong>MONITEUR DEGATS PHYSIQUE</strong>
													</td>
													<td width="50%" style="text-align:center;">
														<strong>MONITEUR DEGATS ETOURDISSANT</strong>
													</td>
												</tr>
												<tr>
										...
										<xsl:otherwise>
											<strong>Moniteur de Condition</strong>
											<xsl:call-template name="ConditionMonitor">
							...
							<tr>
								<td width="25%" class="tableborder">
									<xsl:choose>
										<xsl:when test="isnexus = 'True'">
											<strong>Limite Persona</strong>
										</xsl:when>
										<xsl:otherwise>
											<strong>Limite Processeur</strong>
										</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="25%" class="tableborder">
							...
							<tr>
								<td width="50%" class="tableborder" colspan="2">
									<strong>Programmes/Données</strong>
								</td>
							</tr>
							<tr>
