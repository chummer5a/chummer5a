		...
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
			...
			<body>
					<table width="100%" cellspacing="0" cellpadding="2" border="0" style="border: solid 2px #000000;">
						<tr>
							<td>
								...
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
								<strong>Mouvement:</strong> <xsl:value-of select="movement" />
								<table width="100%" cellspacing="0" cellpadding="2">
									<tr>
										...
										<td width="9%" align="center"><strong>F</strong></td>
										<td width="9%" align="center"><strong>C</strong></td>
										<td width="9%" align="center"><strong>I</strong></td>
										<td width="9%" align="center"><strong>L</strong></td>
										<td width="9%" align="center"><strong>V</strong></td>
										<td width="9%" align="center"><strong>C</strong></td>
									...
									<tr colspan="11">
										...
										<td width="9%" align="center" valign="top"><strong>INTERFACE</strong></td>
										<td width="9%" align="center" valign="top"><strong>ASTRALE</strong></td>
										<td width="9%" align="center" valign="top"><strong>RA</strong></td>
										<td width="9%" align="center" valign="top"><strong>COLD SIM</strong></td>
										<td width="9%" align="center" valign="top"><strong>HOT SIM</strong></td>
										<td width="9%" align="center" valign="top"><strong>MC</strong></td>
										<td width="9%" align="center" valign="top"><strong>PHYSIQUE</strong></td>
										<td width="9%" align="center" valign="top"><strong>MENTALE</strong></td>
										<td width="9%" align="center" valign="top"><strong>SOCIALE</strong></td>
									</tr>
									<tr colspan="11">
									</tr>
									<tr colspan="11">
								...
								<p><strong>Compétences Actives: </strong>
								...
								<xsl:if test="skills/skill[knowledge = 'True' and (rating &gt; 0 or total &gt; 0 or rating = 0)]">
									<p><strong>Compétences de Connaissances: </strong>
								...
								<table width="100%" cellspacing="0" cellpadding="0">
									<tr>
										<td width="49%" valign="top">
											<table width="100%" cellspacing="0" cellpadding="2">
												<tr>
													...
													<td align="center"><strong>Réserve</strong></td>
										...
										<td width="25%" valign="top">
											<table width="100%" cellspacing="0" cellpadding="2">
												<tr>
													<td><strong>Compétence de Combat</strong></td>
										...
										<td width="25%" valign="top">
											<table width="100%" cellspacing="0" cellpadding="2">
												<tr>
													<td><strong>Armure (<xsl:value-of select="armor" />)</strong></td>
													<td align="center"> </td>
												</tr>
								...
								<xsl:if test="critterpowers/critterpower">
									<p><strong>Pouvoirs Créature: </strong>
								...
								<xsl:if test="complexforms/complexform">
									<p><strong>Formes Complexes: </strong>
                ...
                <xsl:if test="aiprograms/aiprogram">
                  <p>
                    <strong>Programmes IA et Programmes Avancées: </strong>
