  ...
  <xsl:template name="SectionHeading">
    ...
    <xsl:param name="SectionBlock">Block Blank</xsl:param>
                      ...
                      <tr>
                        ...
                        <td class="rowsummarybutton" width="150" onClick="showhide(this,'$SectionBlock');">Montrer: OUI</td>
                        <td class="rowsummarybutton" width="150" onClick="zalomit(this,'$SectionBlock');">Saut de Page: NON</td>
											</tr>
										</table>
	</xsl:template>
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborderright tableborderbottom">
        <tr>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborderleft" style="padding-left:3px;">
              <tr>
                ...
                <!-- Skills Block -->
                      ...
                      <tr><td colspan="4" class="ItemListHeader">Compétences Actives</td></tr>
											<tr>
												<td width="50%">
		  ...
		  <xsl:if test="gears/gear"> <!-- Vehicle Gear Section -->
                  <table class="ItemList">
                    <tr><td class="ItemListHeader">Equipement</td></tr>
		...
		<xsl:param name="weapon" />
				...
				<xsl:if test="ranges/short != ''">
								<tr>
									...
									<td></td>
									<td style="text-align:center;" valign="top">C: <xsl:value-of select="ranges/short" /></td>
				...
				<xsl:if test="underbarrel/weapon/ranges/short != ''">
								<tr>
									...
									<td></td>
									<td style="text-align:center;" valign="top">C: <xsl:value-of select="underbarrel/weapon/ranges/short" /></td>
  ...
  <xsl:variable name="SkillStack">
    <xsl:choose>
      <xsl:when test="category = 'Bikes'">
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Véhicules Terrestres</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Mécanique Automobile</xsl:with-param></xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="category = 'Hovercraft'">
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Appareils Volants</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Véhicules Terrestres</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Véhicules Aquatiques</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Mécanique Aéronautique</xsl:with-param></xsl:call-template>
      </xsl:when>
      <xsl:when test="category = 'Watercraft'">
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Véhicules Aquatiques</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Mécanique Nautique</xsl:with-param></xsl:call-template>
      </xsl:when>
      <xsl:when test="category = 'Gliders and FPMV'">
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Appareils Volants</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Mécanique Aéronautique</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Chute Libre</xsl:with-param></xsl:call-template>
      </xsl:when>
      ...
      <xsl:when test="category = 'Military, Security and Medical Craft'">
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Appareils Spatiaux</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Appareils Volants</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Marcheurs</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Véhicules Terrestres</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Véhicules Aquatiques</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Mécanique Aéronautique</xsl:with-param></xsl:call-template>
        <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Mécanique Automobile</xsl:with-param></xsl:call-template>
    ...
    <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Armes de Véhicules</xsl:with-param></xsl:call-template>
    <xsl:call-template name="SkillPull"><xsl:with-param name="SkillName">Orientation</xsl:with-param></xsl:call-template>
