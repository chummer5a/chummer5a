...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/characters/character">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
            ...
            <body> == Info == <br/>Nom: <xsl:value-of select="name"/>
                ...
                </xsl:call-template> Pseudo: <xsl:value-of select="alias"/>
                ...
                </xsl:if> Mouvement: <xsl:value-of select="movement"/>
                ...
                </xsl:choose> Sang-Froid: <xsl:value-of select="composure"/>
                ...
                </xsl:call-template> Jaugé les Intentions: <xsl:value-of select="judgeintentions"/>
                ...
                </xsl:call-template> Soulever/Transporter: <xsl:value-of select="liftandcarry"/>
                ...
                </xsl:call-template> Mémoire: <xsl:value-of select="memory"/>
                ...
                </xsl:call-template> Peau: <xsl:value-of select="skin"/>
                <br/>Yeux: <xsl:value-of select="eyes"/>
                <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                </xsl:call-template> Cheveux: <xsl:value-of select="hair"/>
                
                <xsl:if test="prioritymetatype != ''">
                    <br/>
                    <br/>== Priorités == <br/>Métatype: <xsl:value-of select="prioritymetatype"/>
                    <br/>Attributs: <xsl:value-of select="priorityattributes"/>
                    <br/>Spécial: <xsl:value-of select="priorityspecial"/>
                    <br/>Compétences: <xsl:value-of select="priorityskills"/>
                    <br/>Ressources: <xsl:value-of select="priorityresources"/>
                    <xsl:if test="priorityskill1 != ''">
                        <br/><xsl:text>Compétence Bonus: </xsl:text><xsl:value-of select="priorityskill1"
                        />
                    </xsl:if>
                    <xsl:if test="priorityskill2 != ''">
                        <br/><xsl:text>Compétence Bonus: </xsl:text><xsl:value-of select="priorityskill2"
                        />
                    </xsl:if>
                    <xsl:if test="priorityskillgroup != ''">
                        <br/><xsl:text>Groupe de Compétence Bonus: </xsl:text><xsl:value-of
                ...
                VOL: <xsl:value-of select="attributes/attribute[name = 'WIL']/base"/>
                <xsl:if
                ...
                <br/>Moniteur de Condition Physique: <xsl:value-of select="physicalcm"/>
                <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                Init Interfacé: <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                <br/>Moniteur de Condition Etourdissant: <xsl:value-of select="stuncm"/>
                <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                Init Astrale: <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                <br/>Physique: <xsl:value-of select="limitphysical"/>
                <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                Init RA: <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                <br/>Mentale: <xsl:value-of select="limitmental"/>
                <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                Init Cold SIM: <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                <br/>Sociale: <xsl:value-of select="limitsocial"/>
                <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                Init Hot SIM: <xsl:call-template name="for.loop">
                    <xsl:with-param name="i">
                ...
                <br/>Astrale: <xsl:value-of select="limitastral"/>
                <xsl:call-template name="limitmodifiersast"/>
                
                <br/>
                <br/>== Compétences Actives == <xsl:call-template name="skills"/>
                <br/>
                <br/>== Compétences de Connaissances == <xsl:call-template name="knowledgeskills"/>
                ...
                <xsl:if test="qualities/quality">
                    <br/>
                    <br/>== Traits == <xsl:call-template name="qualities"/>
                </xsl:if>
                <xsl:if test="spells/spell">
                    <br/>
                    <br/>== Sorts == <br/>(Tradition: <xsl:value-of select="tradition/name"/>, Résistance
                    Drain avec <xsl:value-of select="tradition/drain"/>) <xsl:call-template name="spells"/>
                </xsl:if>
                <xsl:if test="powers/power">
                    <br/>
                    <br/>== Pouvoirs == <xsl:call-template name="powers"/>
                </xsl:if>
                <xsl:if test="complexforms/complexform">
                    <br/>
                    <br/>== Formes Complexes == <br/>(Tradition: <xsl:value-of select="stream"/>,
                    Resistance Technodrain avec <xsl:value-of select="drain"/>) <xsl:call-template
                        name="complexforms"/>
                </xsl:if>
              <xsl:if test="aiprograms/aiprogram">
                <br/>
                <br/>== Programmes IA et Programmes Avancées == <xsl:call-template name="aiprograms"/>
              </xsl:if>
                <xsl:if test="critterpowers/critterpower">
                    <br/>
                    <br/>== Pouvoirs Créature == <xsl:call-template name="critterpowers"/>
                </xsl:if>
                <xsl:if test="lifestyles/lifestyle">
                    <br/>
                    <br/>== Niveau de Vie == <xsl:call-template name="lifestyle"/>
                </xsl:if>
                ...
                <xsl:if test="armors/armor">
                    <br/>
                    <br/>== Armures == <xsl:call-template name="armors"/>
                </xsl:if>
                <xsl:if test="weapons/weapon">
                    <br/>
                    <br/>== Armes == <xsl:call-template name="weapons"/>
                </xsl:if>
                <xsl:if test="martialarts/martialart">
                    <br/>
                    <br/>== Arts Martiaux == <xsl:call-template name="martialarts"/>
                </xsl:if>
                <xsl:if
                ...
                <xsl:if test="gears/gear[iscommlink != 'True']">
                    <br/>
                    <br/>== Equipement == <xsl:call-template name="gear"/>
                </xsl:if>
                <xsl:if test="vehicles/vehicle">
                    <br/>
                    <br/>== Vehicules == <xsl:call-template name="vehicles"/>
                </xsl:if>
                <xsl:if test="expenses">
                    <br/>
                    <br/>== Dépenses de Karma == <xsl:call-template name="karmaexpenses"/>
                </xsl:if>
                <xsl:if test="expenses">
                    <br/>
                    <br/>== Dépenses de Nuyen == <xsl:call-template name="nuyenexpenses"/>
                </xsl:if>
    ...
    <xsl:template name="skills">
        ...
        <xsl:for-each select="$items">
            ...
            </xsl:call-template>    Réserve: <xsl:value-of select="total"/>
    ...
    <xsl:template name="contacts">
        <xsl:for-each select="contacts/contact">
            ...
            <br/><xsl:value-of select="name"/><xsl:if test="role != ''"> (<xsl:value-of
                ...
                /></xsl:if> (INF: <xsl:value-of select="connection"/>, LOY: <xsl:value-of select="loyalty"/>)
    ...
    <xsl:template name="spells">
        <xsl:for-each select="spells/spell">
            ...
            </xsl:choose> VD: <xsl:value-of select="dv"/>
        </xsl:for-each>
    </xsl:template>
    ...
    <xsl:template name="powers">
        <xsl:for-each select="powers/power">
            ...
            <xsl:value-of select="name"/>
            <xsl:if test="extra != ''"> (<xsl:value-of select="extra"/>)</xsl:if>
            <xsl:if test="rating &gt; 0"> Niveau: <xsl:value-of select="rating"/></xsl:if>
        </xsl:for-each>
    </xsl:template>
    ...
    <xsl:template name="complexforms">
        <xsl:for-each select="complexforms/complexform">
            ...
            <xsl:value-of select="name"/>
            <xsl:if test="extra != ''"> (<xsl:value-of select="extra"/>)</xsl:if>
            <xsl:if test="rating &gt; 0"> Puissance: <xsl:value-of select="rating"/></xsl:if>
            <xsl:if test="programoptions/programoption"> (<xsl:for-each
                ...
                </xsl:for-each>) </xsl:if> Cible: <xsl:value-of select="target"/>, 
  ...
  <xsl:template name="aiprograms">
    <xsl:for-each select="aiprograms/aiprogram">
      ...
      <xsl:if test="extra != ''">
        Requis: <xsl:value-of select="requiresprogram"/>
      </xsl:if>
    ...
    <xsl:template name="commlinks">
        <xsl:for-each select="gears/gear[iscommlink = 'True']">
            <xsl:sort select="name"/>
            <br/><xsl:value-of select="name"/> (ATT: <xsl:value-of select="attack"/>, COR:
                <xsl:value-of select="sleaze"/>, TD: <xsl:value-of select="dataprocessing"/>, FWL:
    ...
    <xsl:template name="weapons">
        <xsl:for-each select="weapons/weapon">
            ...
            <br/>&#160;&#160;&#160;Réserve: <xsl:value-of select="dicepool"
            />
            <xsl:call-template name="for.loop">
                <xsl:with-param name="i">
            ...
            </xsl:call-template>Précision: <xsl:value-of select="accuracy"/>
            <xsl:call-template name="for.loop">
                <xsl:with-param name="i">
            ...
            </xsl:call-template>VD: <xsl:value-of select="damage"/>
            <xsl:call-template name="for.loop">
                <xsl:with-param name="i">
            ...
            </xsl:call-template>PA: <xsl:value-of select="ap"/>
            <xsl:call-template name="for.loop">
                <xsl:with-param name="i">
            ...
            </xsl:call-template>CR: <xsl:value-of select="rc"/>
        </xsl:for-each>
    </xsl:template>
        ...
        <xsl:for-each select="vehicles/vehicle">
            ...
            <xsl:if test="weapons/weapon">
                <xsl:for-each select="weapons/weapon">
                    ...
                    <br/>&#160;&#160;&#160;&#160;&#160;&#160;VD: <xsl:value-of select="damage"
                    />&#160;&#160;&#160;PA: <xsl:value-of select="ap"/>&#160;&#160;&#160;CR:
