...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
							...
							<td width="100%" class="tableborder">
								<table width="100%" cellspacing="0" cellpadding="2" border="0">
									<tr>
										...
										<td colspan="2"> MOUVEMENT: <xsl:value-of select="movement"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="10%">POIDS:</td>
										<td width="10%">
											<xsl:value-of select="weight"/>
										</td>
										<td width="10%">CHEVEUX:</td>
										<td width="10%">
								...
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
										...
										<xsl:for-each select="calendar/week">
											<tr>
												<td>
													<xsl:value-of select="year"/>: Mois <xsl:value-of select="month"/>, Semaine <xsl:value-of select="week"/>
												</td>
										...
										<tr>
											<td class="rowsummary" colspan="3"> ENTREES CALENDRIER
												<span class="rowsummarybutton" onClick="showhide(this,'CalendarBlock');" colspan="1">Montrer: OUI</span>
												<span class="rowsummarybutton" onClick="zalomit(this,'CalendarBlock');" colspan="1">Saut de Page: NON</span>
											</td>
										</tr>
									</table>
								</td>
								...
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tr>
										<td width="25%" style="text-align:center;"
											class="attributecell">
											<strong>ATTRIBUTS PHYSIQUE</strong>
										</td>
										<td width="25%" style="text-align:center;"
											class="attributecell">
											<strong>ATTRIBUTS MENTAUX</strong>
										</td>
										<td width="25%" style="text-align:center;"
											class="attributecell">
											<strong>ATTRIBUTS SPECIAUX</strong>
										</td>
										<td width="25%" style="text-align:center;"
											class="attributecell">
									...
									<tr>
										...
										<td width="25%" class="attributecell">
											<p>POINT DE CHANCE ACTUEL:</p>
										</td>
										<td width="25%" class="attributecell">
											<p>
												<xsl:choose>
												<xsl:when test="magenabled = 'True'"> INIT ASTRALE:
									...
									<tr>
										...
										<td width="25%" class="attributecell">
											<p> INIT INTERFACE: <xsl:value-of select="riggerinit"
												/>
											</p>
										</td>
									</tr>
									<tr>
										...
										<td width="25%" class="attributecell" valign="top">
											<p>
												<xsl:if test="magenabled = 'True'"> MAGIE:
													<xsl:value-of
										...
										<td width="25%" class="attributecell">
											<p> RA: <xsl:value-of select="matrixarinit"/><br />
												COLD SIM: <xsl:value-of
													select="matrixcoldinit"/><br />
												HOT SIM: <xsl:value-of
													select="matrixhotinit"/>
											</p>
										</td>
									</tr>
									<tr>
										<td class="rowsummary" colspan="4"> ATTRIBUTS <span
												class="rowsummarybutton"
												onClick="showhide(this,'AttributesBlock');"
												colspan="1">Montrer: OUI</span>
											<span class="rowsummarybutton"
												onClick="zalomit(this,'AttributesBlock');"
												colspan="1">Saut de Page: NON</span>
										</td>
									</tr>
								</table>
							</td>
								...
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tr>
										<td width="33%" style="text-align:center;" valign="top">
											<strong>COMPETENCES ACTIVES</strong>
										...
										<td width="33%" style="text-align:center;" valign="top">
											<strong>COMPETENCES DE CONNAISSANCES</strong>
											<table width="100%" cellspacing="0" cellpadding="0"
												border="0">
												<tr>
												<td width="45%">
					...
					<table width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100%" class="tableborder">
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tr>
										<td width="25%" style="text-align:center;" valign="top">
											<strong> LIMITE PHYSIQUE: <xsl:value-of
												select="limitphysical"/></strong>
										</td>
										<td width="25%"
											style="border-left: solid 1px #1c4a2d; border-right: solid 1px #1c4a2d; text-align:center;"
											valign="top">
											<strong>LIMITE MENTALE: <xsl:value-of select="limitmental"
												/></strong>
										</td>
										<td width="25%" style="border-right: solid 1px #1c4a2d; text-align:center;" valign="top">
											<strong>LIMITE SOCIALE: <xsl:value-of select="limitsocial"
												/></strong>
										</td>
										<td width="25%" style="text-align:center;" valign="top">
											<strong>LIMITE ASTRALE: <xsl:value-of select="limitastral"
											/></strong>
										</td>
									</tr>
									<tr>
								...
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tr>
										<td class="rowsummary" colspan="3"> LIMITES <span
												class="rowsummarybutton"
									...
									<tr>
										<td width="67%" style="text-align:center;" valign="top">
											<table width="100%" cellspacing="0" cellpadding="0"
												...
												<tr>
												<td class="rowsummary" colspan="2"> TRAITS
												</td>
												</tr>
												</table>
												</td>
												...
												<tr>
												<td class="rowsummary" colspan="3"> ARMURE <span
												class="rowsummarybutton"
										...
										<td width="33%" style="text-align:center;" valign="top">
											<table width="100%" cellspacing="0" cellpadding="0"
												...
												<strong>MONITEUR DE CONDITION PHYSIQUE</strong>
												</td>
												<td width="50%" style="text-align:center;">
												<strong>MONITEUR DE CONDITION ETOURDISSANT</strong>
												</td>
												</tr>
												<tr>
												...
												<tr>
												<td class="rowsummary" colspan="2"> MONITEUR DE 
												CONDITION </td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td width="100%" valign="top">
											<table width="100%" cellspacing="0" cellpadding="0"
												...
												<tr>
												<td class="rowsummary" colspan="9"> ARMES A DISTANCE
												</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td width="100%" valign="top">
											<table width="100%" cellspacing="0" cellpadding="0"
												...
												<tr>
												<td class="rowsummary" colspan="8"> ARMES DE MELEE
													<span class="rowsummarybutton"
								...
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											...
											<td width="13%" style="text-align:center;">
												<strong>Esprit de Combat</strong>
											</td>
											<td width="13%" style="text-align:center;">
												<strong>Esprit de Détection</strong>
											</td>
											<td width="13%" style="text-align:center;">
												<strong>Esprit de Santé</strong>
											</td>
											<td width="13%" style="text-align:center;">
												<strong>Esprit d'Illusion</strong>
											</td>
											<td width="13%" style="text-align:center;">
												<strong>Esprit de Manipulation</strong>
											</td>
											<td width="13%" style="text-align:center;">
												<strong>Drain</strong>
											</td>
							...
							<tr>
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											<td class="rowsummary" colspan="7"> SORTS <span
												class="rowsummarybutton"
									...
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											<td>
												...
												<strong>GRADE SUBMERSION: </strong>
												<xsl:value-of select="submersiongrade"/>
												</xsl:when>
												<xsl:otherwise>
												<strong>GRADE INITIATION: </strong>
							...
							<td>
								<table width="100%" cellspacing="0" cellpadding="0" border="0"
									...
									<tr>
										...
										<td width="14%" style="text-align:center;">
											<strong>TRAIT. DE DONNEES</strong>
										</td>
										<td width="14%" style="text-align:center;">
									...
									<tr>
										<td class="rowsummary" colspan="7"> APPAREILS/PROGRAMMES <span
												class="rowsummarybutton"
							...
							<tr>
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											<td class="rowsummary" colspan="4"> POUVOIRS ADEPTE <span
												class="rowsummarybutton"
							...
							<tr>
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											<td class="rowsummary" colspan="3"> POUVOIRS DE CREATURE <span
												class="rowsummarybutton"
							...
							<tr>
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											<td class="rowsummary" colspan="5"> FORMES COMPLEXE <span
												class="rowsummarybutton"
                ...
                <td>
                  <table width="100%" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                      ...
                      <td width="40%">
                        <strong>PROGRAMME REQUIS</strong>
                      </td>
                      <td width="20%" style="text-align:center;"> </td>
                    </tr>
                    ...
                    <tr>
                      <td class="rowsummary" colspan="3">
                        PROGRAMMES IA ET PROGRAMMES AVANCEES<span
												class="rowsummarybutton"
							...
							<tr>
								<td>
									<table width="100%" cellspacing="0" cellpadding="0" border="0"
										...
										<tr>
											<td class="rowsummary" colspan="2"> ARTS MARTIAUX <span
												class="rowsummarybutton"
							...
							<tr>
								<td width="100%" class="tableborder">
									<table width="100%" cellspacing="0" cellpadding="0" border="0">
										...
										<tr>
											<td class="rowsummary" colspan="3"> NIVEAU DE VIE <span
												class="rowsummarybutton"
						...
						<tr>
							<td width="100%" class="tableborder">
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									...
									<tr>
										<td class="rowsummary" colspan="3"> EQUIPEMENT <span
												class="rowsummarybutton"
									...
									<table width="100%" cellspacing="0" cellpadding="0" border="0">
										<tr>
											<td width="50%" valign="top">
												...
												<tr>
												<td class="rowsummary" colspan="3"> DEPENSES KARMA
												<span class="rowsummarybutton"
											...
											<td width="50%" valign="top">
												...
												<tr>
												<td class="rowsummary" colspan="3"> DEPENSES NUYEN
												</td>
												</tr>
												</table>
											</td>
	...
	<xsl:template name="rangedweapons">
			...
			<tr>
				...
				<td colspan="9" class="indent">
					...
					<xsl:for-each select="mods/weaponmod">
						<xsl:sort select="name"/>
						<xsl:value-of select="name"/>
						<xsl:if test="rating > 0"> Indice <xsl:value-of select="rating"/>
						</xsl:if>
						<xsl:if test="position() != last()">; </xsl:if>
					</xsl:for-each>
				</td>
		...
		<xsl:if test="ranges/short != ''">
			<tr>
				...
				<td/>
				<td style="text-align:center;" valign="top">C: <xsl:value-of select="ranges/short"
					/></td>
		...
		<xsl:if test="underbarrel/weapon">
			<xsl:for-each select="underbarrel/weapon">
				<tr>
					...
					<td width="20%" valign="top"> ND <xsl:value-of select="name"/>
				...
				<xsl:if test="ranges/short != ''">
					<tr>
						...
						<td/>
						<td style="text-align:center;" valign="top">C: <xsl:value-of
	...
	<xsl:template name="cyberware">
		<xsl:for-each select="cyberwares/cyberware">
			...
			<tr>
				...
				<td width="50%" valign="top">
					<xsl:value-of select="name"/>
					<xsl:if test="rating != 0"> Indice <xsl:value-of select="rating"/></xsl:if>
			...
			<td width="13%" style="text-align:center;">
				<xsl:choose>
					<xsl:when test="qualities/quality[name='Adept']">
						CON + VOL (<xsl:value-of select="attributes/attribute[name='BOD']/total +attributes/attribute[name='WIL']/total"/>)
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:when test="position() = 1">
					<tr>
						<td colspan="7" style="border-bottom:solid black 1px;">
							<strong><xsl:value-of select="category"/> Sorts</strong>
						</td>
					</tr>
				</xsl:when>
				<xsl:otherwise>
	...
	<xsl:template name="complexforms">
		<tr>
			<td colspan="5" valign="top"> Flux: <xsl:value-of select="stream"/>&#160;&#160;&#160;
				Resist Technodrain avec <xsl:value-of select="drain"/>
			</td>
		</tr>
								...
								<tr>
									<td colspan="15" class="indent">
										<xsl:for-each select="mods/mod">
											<xsl:sort select="name"/>
											<xsl:value-of select="name"/>
											<xsl:if test="rating != 0"> Indice <xsl:value-of
												select="rating"/></xsl:if>
                      ...
                      <xsl:if test="position() != last()">; </xsl:if>
							...
							<tr>
								<td class="rowsummary" colspan="15">
									<table width="100%" cellspacing="0" cellpadding="0" border="0">
										<tr>
											<td class="rowsummary"> VEHICULE/DRONE </td>
											<td class="rowsummarybutton" colspan="1">
												<xsl:attribute name="onClick"
												>showhide(this,'<xsl:value-of
												select="$VehicleNumber"/>');</xsl:attribute> Montrer:
												OUI </td>
