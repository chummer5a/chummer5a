...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- test values -->
	<xsl:variable name="lang.Range1"		select="'T'"/>
	<xsl:variable name="lang.Range2"		select="'LOS'"/>
	<xsl:variable name="lang.Range3"		select="'LOS(A)'"/>
	<xsl:variable name="lang.Range4"		select="'LOS (A)'"/>
