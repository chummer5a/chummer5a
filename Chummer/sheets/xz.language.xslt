...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:variable name="lang"  select="string('en')" />
  <xsl:variable name="locale"  select="string('en-us')" />
  ...
  <xsl:variable name="lang.Day"      select="string('Day')" />
  <xsl:variable name="lang.Days"      select="string('Days')" />
  ...
  <xsl:variable name="lang.Month"      select="string('Month')" />
  <xsl:variable name="lang.Months"    select="string('Months')" />
  ...
  <xsl:variable name="lang.Week"      select="string('Week')" />
  <xsl:variable name="lang.Weeks"      select="string('Weeks')" />
