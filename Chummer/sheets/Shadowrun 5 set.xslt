		...
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
			...
			<body>
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'PersonalDataBlock'"/>
					</xsl:call-template>
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'AttributesBlock'"/>
					</xsl:call-template>
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'LimitsBlock'"/>
					</xsl:call-template>
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'SkillsBlock'"/>
					</xsl:call-template>
				...
				<xsl:if test="powers/power">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'PowersBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="martialarts/martialart">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'MartialArtsBlock'"/>
					</xsl:call-template>
				</xsl:if>
...
-->
				<xsl:if test="cyberwares/cyberware">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'CyberwareBlock'"/>
					</xsl:call-template>
				</xsl:if>
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'ArmorBlock'"/>
					</xsl:call-template>
				...
				<xsl:if test="weapons/weapon[type = 'Ranged']">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'RangedWeaponsBlock'"/>
					</xsl:call-template>
				</xsl:if>
					...
					<div class="block" id="MeleeWeaponsBlock">
						...
						<table class="tablestyle">
							...
							<xsl:for-each select="msxsl:node-set($sortedcopy)/weapon">
								<xsl:if test="position()=1 or location != preceding-sibling::weapon">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'MeleeWeaponsBlock'"/>
					</xsl:call-template>
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'GearBlock'"/>
					</xsl:call-template>
				...
				<xsl:if test="gears/gear[iscommlink = 'True']">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'DevicesBlock'"/>
					</xsl:call-template>
				</xsl:if>
			...
			<xsl:if test="magenabled = 'True'">
				<xsl:if test="tradition/name != ''">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'TraditionBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="initiategrade > 0">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'InitiationBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="spirits/spirit">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'SpiritsBlock'"/>
					</xsl:call-template>
				</xsl:if>
			</xsl:if>
...
-->
			<xsl:if test="resenabled = 'True'">
				...
				<xsl:call-template name="RowSummary">
					...
					<xsl:with-param name="bnme" select="'StreamBlock'"/>
				</xsl:call-template>
				...
				<xsl:if test="submersiongrade > 0">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'EchoesBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="complexforms/complexform">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'ComplexFormsBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="spirits/spirit">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'SpritesBlock'"/>
					</xsl:call-template>
				</xsl:if>
			</xsl:if>
<!-- ** ** ** end of Technomancer details ** ** ** -->
				...
				<xsl:if test="aiprograms/aiprogram">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'AIProgramBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="contacts/contact">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'ContactsBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="critterpowers/critterpower">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'CritterBlock'"/>
					</xsl:call-template>
				</xsl:if>
			...
			<xsl:if test="$ProduceNotes">
				...
				<xsl:if test="hasothermugshots = 'yes'">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'OtherMugshotsBlock'"/>
					</xsl:call-template>
				</xsl:if>
				...
				<xsl:if test="calendar/week">
					...
					<xsl:call-template name="RowSummary">
						...
						<xsl:with-param name="bnme" select="'CalendarBlock'"/>
					</xsl:call-template>
				</xsl:if>
...
<!-- ** ** ** end of notes ** ** ** -->
	...
	<xsl:template name="vehicles">
		...
		<xsl:call-template name="RowSummary">
			...
			<xsl:with-param name="bnme" select="$VehicleNumber"/>
		</xsl:call-template>
	</xsl:template>
		...
		<xsl:for-each select="children/gear">
			...
			<xsl:choose>
				<xsl:when test="children/gear">
					with <xsl:call-template name="gearplugin">
						<xsl:with-param name="gear" select="."/>
					</xsl:call-template>
