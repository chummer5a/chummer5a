...
#region ContextMenu Events
        ...
        private void tsWeaponAccessoryAddAccessory_Click(object sender, EventArgs e)
        {
            ...
            do
            {
                ...
                if (objParent.Children.Count >= objParent.AccessoryLimit)
                {
                ...
                foreach (XmlNode objXmlMount in objParent.GetNode().SelectNodes("accessorymounts/mount"))
                {
                    ...
                    if (!objParent.Children.Any(objMod =>
                ...
                })
                {
                    ...
                    objParent.Children.Add(objAccessory);
                }

                IsCharacterUpdateRequested = true;
                IsDirty = true;
            }
            while (blnAddAgain && objParent.Children.Count < objParent.AccessoryLimit);
        }
